...
/**
 * Get (value)  
 * = {"0","1","2","3","4","5"}; String[] mlDefault = new
 * String[]{"全部","子女教育","继续教育","住房贷款利息","住房租金","赡养老人"};
 * 
 * 附加专项扣除
 * 
 * @author: xuhw
...
public class WATaxFunSpecialAdditionaDeductionLJProcesser extends AbstractWAFormulaParse {
