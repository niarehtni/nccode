...
public class ClassitemDAO extends BaseDAOManager {
	...
	private String getFileds() {
		String sql = "select   wa_item.clearflag,wa_item.code,  wa_item.defaultflag, wa_classitem.iflddecimal, wa_item.ifldwidth, wa_item.iitemtype, wa_item.intotalitem, wa_item.iprivil, wa_item.iproperty, wa_item.isinhi, wa_item.mid, wa_item.pk_budget_item,  wa_item.totalitem,"
				...
				// MOD {查询出20个自定义项} kevin.nie 2017-09-13 start
				+ "wa_classitem.def1, wa_classitem.def2, wa_classitem.def3, wa_classitem.def4, wa_classitem.def5, wa_classitem.def6, wa_classitem.def7, wa_classitem.def8, wa_classitem.def9, wa_classitem.def10, "
				+ "wa_classitem.def11, wa_classitem.def12, wa_classitem.def13, wa_classitem.def14, wa_classitem.def15, wa_classitem.def16, wa_classitem.def17, wa_classitem.def18, wa_classitem.def19, wa_classitem.def20, "
		...
		// {查询出20个自定义项} kevin.nie 2017-09-13 end
		return sql;
		// end
	}
