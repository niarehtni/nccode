...
public class GetAggIncomeTaxDataImpl implements IGetAggIncomeTaxData {
	...
	public List<AggIncomeTaxVO> getAggIncomeTaxData(boolean isForeignMonth,
		...
		qrySql.append(")");
		qrySql.append("where \n");
		qrySql.append(" wac.declareform= '" + declaretype + "'\n");// 申报凭单格式
		...
		for (int i = 0; i < orgs.length; i++) {
			...
			if ("1001ZZ1000000001O22Q".equals(twhr07)) {// 发放日期
				String firstday = getFirstDayOfMonth(Integer.parseInt(year),
						Integer.parseInt(beginMonth));
				String lastday = getLastDayOfMonth(Integer.parseInt(year),
