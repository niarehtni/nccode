 ...
 * @author: xuhw
 */
public class Taxupgrade_toolInitPeriodAction extends HrAction {
	...
	public Taxupgrade_toolInitPeriodAction() {
		super();
		putValue(INCAction.CODE, "Taxupgrade_toolInitPeriodAction");
		setBtnName("1、升级薪资期间");
		putValue(Action.SHORT_DESCRIPTION, "1、快速升级纳税年度纳税期间");
	}
	...
	public void doAction(ActionEvent e) throws Exception {
		...
		((Taxupgrade_toolModelService)getModel().getService()).taxUpgradeToSelectClass(PubEnv.getPk_group(), itemvos, vos, TaxupgradeDef.OPTYPE_INITTAXPERIOD);
		getEditor().initUI();
	}
