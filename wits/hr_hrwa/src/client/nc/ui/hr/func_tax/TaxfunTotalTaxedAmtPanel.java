...
/**
 * 累计已扣税 按照累计额根据年度税表计算应纳税(参数：薪资项目(累计应纳税所得额)，薪资项目(本次应纳税所得))
 * 
 * @author harvey
 */
public class TaxfunTotalTaxedAmtPanel extends UIPanel implements ItemListener,
	 ...
	 * WaParaPanel 构造子注解。
	 */
	public TaxfunTotalTaxedAmtPanel() {
		super();
		initialize();
	}
