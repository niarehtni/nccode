 ...
 * @author harvey
 */
public class TaxfunTaxableAmtCurrentPeriodPanel extends UIPanel implements ItemListener,
	 ...
	 * WaParaPanel 构造子注解。
	 */
	public TaxfunTaxableAmtCurrentPeriodPanel() {
		super();
		initialize();
	}
