...
public interface TaxupgradeDef {
	...
	/**累计应纳税所得额预制*/
	String TAXITEM_FORMULASTR_TOTAL_TAXABLE_INCOME_YZ2 = "新税改_累计应纳税所得额(#应纳税所得额_预制#)";
	/**累计应纳税*/
	String TAXITEM_FORMULASTR_TOTAL_TAXABLEAMT_YZ3 = "新税改_累计应纳税(#累计应纳税所得额_预制#)";
	/**累计已扣税*/
	String TAXITEM_FORMULASTR_TOTAL_TAXEDAMT_YZ4 = "新税改_累计已扣税(#累计应纳税所得额_预制#,#应纳税所得额_预制#)";
	/**本次扣税*/
	String TAXITEM_FORMULASTR_TAXABLEAMT_YZ5 = "[薪资发放项目.#累计应纳税_预制#] - [薪资发放项目.#累计已扣税_预制#]";
	
	/**新税改_适用税率*/
	String TAXITEM_FORMULASTR_TAX_RATE_YZ6 = "新税改_适用税率(#累计应纳税所得额_预制#)";
	/**新税改_速算扣除数*/
	String TAXITEM_FORMULASTR_TAX_QUICK_DEDUCTION_YZ7 = "新税改_速算扣除数(#累计应纳税所得额_预制#)";
	/**新税改_基本扣除数*/
