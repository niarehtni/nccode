...
public class ProjSalaryHVO extends SuperVO {
	// 分割符合
	 ...
	 * @return 主键
	 */
	public String getPk_projsalary() {
		return this.pk_projsalary;
	}
	 ...
	 *            主键
	 */
	public void setPk_projsalary(String pk_projsalary) {
		this.pk_projsalary = pk_projsalary;
	}
	 ...
	 *            金额
	 */
	public void setSalaryamt(UFDouble salaryamt) {
	...
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("hrwa.projsalary");
	}

	/**
	 * @Description: 关键字段组合ID.(unioncode)
	 * @return String
	 */
	public String getID() {
		StringBuilder id = new StringBuilder(pk_psndoc);
		id.append(SPLIT).append(pk_classitem).append(SPLIT).append(def1);
		return id.toString();
	}

	public boolean excelImpCheck() {
		return StringUtils.isNotBlank(pk_psndoc) && StringUtils.isNotBlank(def1)
				&& StringUtils.isNotBlank(pk_classitem)
				&& (null != salaryamt && salaryamt.compareTo(UFDouble.ZERO_DBL) != 0);
	}

	private int sheetno;
	private int rowno;
	private String exl_psncode;
	private String exl_pjcode;
	private String exl_itemname;
	private String exl_amt;
	...
	public String getExl_psncode() {
		return exl_psncode;
	}

	public void setExl_psncode(String exl_psncode) {
		this.exl_psncode = exl_psncode;
	}

	public String getExl_pjcode() {
		return exl_pjcode;
	}

	public void setExl_pjcode(String exl_pjcode) {
		this.exl_pjcode = exl_pjcode;
	}

	public String getExl_itemname() {
		return exl_itemname;
	}

	public void setExl_itemname(String exl_itemname) {
		this.exl_itemname = exl_itemname;
	}

	public String getExl_amt() {
		return exl_amt;
	}

	public void setExl_amt(String exl_amt) {
		this.exl_amt = exl_amt;
	}

	public String getSheetRowNo() {
		return new StringBuilder("[").append(sheetno).append(",").append(rowno).append("]").toString();
	}
