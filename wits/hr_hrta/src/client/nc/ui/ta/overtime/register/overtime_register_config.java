...
public java.lang.Integer getFunc_type(){
 ...
 return (java.lang.Integer)context.get("func_type");
  java.lang.Integer bean = new java.lang.Integer("5");  context.put("func_type",bean);
...
public java.lang.String getNodekey(){
 ...
 return (java.lang.String)context.get("nodekey");
  java.lang.String bean = new java.lang.String("overtimereg");  context.put("nodekey",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
private List getManagedList0(){  List list = new ArrayList();  list.add("overtimereg");  return list;}
...
private List getManagedList2(){  List list = new ArrayList();  list.add(getListViewActions());  list.add(getCardEditorActions());  return list;}
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_1fdb138());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_1fdb138(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#1fdb138")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#1fdb138");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#1fdb138",bean);
...
private List getManagedList3(){  List list = new ArrayList();  list.add(getVSNode_1eaaf74());  list.add(getVSNode_1d02446());  return list;}

private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1eaaf74(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#1eaaf74")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#1eaaf74");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#1eaaf74",bean);
  bean.setShowMode("NoDivider");
  bean.setUp(getCNode_149ed4e());
  bean.setDown(getHSNode_7b29a3());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_149ed4e(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#149ed4e")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#149ed4e");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#149ed4e",bean);
...
private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_7b29a3(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#7b29a3")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#7b29a3");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#7b29a3",bean);
  bean.setLeft(getCNode_7aa9e1());
  bean.setRight(getCNode_126fc41());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_7aa9e1(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#7aa9e1")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#7aa9e1");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#7aa9e1",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_126fc41(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#126fc41")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#126fc41");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#126fc41",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1d02446(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#1d02446")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#1d02446");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#1d02446",bean);
  bean.setShowMode("NoDivider");
  bean.setUp(getCNode_a52319());
  bean.setDown(getCNode_1a372f4());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_a52319(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#a52319")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#a52319");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#a52319",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1a372f4(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1a372f4")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1a372f4");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1a372f4",bean);
...
private List getManagedList4(){  List list = new ArrayList();  list.add(getFirstLineAction());  list.add(getPreLineAction());  list.add(getNextLineAction());  list.add(getLastLineAction());  return list;}
...
public nc.ui.uif2.actions.QueryAreaShell getQueryAreaShell(){
 ...
 return (nc.ui.uif2.actions.QueryAreaShell)context.get("queryAreaShell");
  ...
  bean.setQueryArea(getQueryAction_created_7df146());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.queryarea.QueryArea getQueryAction_created_7df146(){
 if(context.get("QueryAction.created#7df146")!=null)
 return (nc.ui.queryarea.QueryArea)context.get("QueryAction.created#7df146");
  nc.ui.queryarea.QueryArea bean = getQueryAction().createQueryArea();
  context.put("QueryAction.created#7df146",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.hr.uif2.validator.BillNotNullValidateService getBillNotNullValidator(){
 ...
 return (nc.ui.hr.uif2.validator.BillNotNullValidateService)context.get("billNotNullValidator");
  nc.ui.hr.uif2.validator.BillNotNullValidateService bean = new nc.ui.hr.uif2.validator.BillNotNullValidateService(getBillFormEditor());
...
public nc.vo.ta.overtime.register.validator.SaveOvertimeRegValidatorService getOvertimeRegValidator(){
 ...
 return (nc.vo.ta.overtime.register.validator.SaveOvertimeRegValidatorService)context.get("OvertimeRegValidator");
...
private List getManagedList5(){  List list = new ArrayList();  list.add(getAddActionGroup());  list.add(getEditAction());  list.add(getDeleteAction());  list.add(getRefreshAction());  list.add(getSeparatorAction());  list.add(getViewCardInfoAction());  list.add(getSeparatorAction());  list.add(getCardPrintActiongroup());  return list;}

private List getManagedList6(){  List list = new ArrayList();  list.add(getSaveAction());  list.add(getSaveAddAction());  list.add(getSeparatorAction());  list.add(getCancelAction());  return list;}
...
private List getManagedList7(){  List list = new ArrayList();  list.add(getAddActionGroup());  list.add(getEditAction());  list.add(getDeleteAction());  list.add(getSeparatorAction());  list.add(getQueryAction());  list.add(getRefreshAction());  list.add(getViewCardInfoAction());  list.add(getSeparatorAction());  list.add(getCheckgroup());  list.add(getRestgroup());  list.add(getSeparatorAction());  list.add(getPrintGroupAction());  list.add(getSeparatorAction());  list.add(getImportAction());  list.add(getExportAction());  return list;}
...
private java.lang.String getI18nFB_6b4ab7(){
 if(context.get("nc.ui.uif2.I18nFB#6b4ab7")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#6b4ab7");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#6b4ab7",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#6b4ab7",product);
...
public nc.ui.ta.overtime.register.action.ImportOvertimeAction getImportAction(){
 if(context.get("ImportAction")!=null)
 return (nc.ui.ta.overtime.register.action.ImportOvertimeAction)context.get("ImportAction");
  nc.ui.ta.overtime.register.action.ImportOvertimeAction bean = new nc.ui.ta.overtime.register.action.ImportOvertimeAction();
  context.put("ImportAction",bean);
  bean.setModel(getManageAppModel());
  bean.setNcActionStatusJudge(getEnableJudge());
  bean.setRestOvertimeAction(getRestAction());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

public nc.ui.ta.overtime.register.action.ExportOvertimeAction getExportAction(){
 if(context.get("ExportAction")!=null)
 return (nc.ui.ta.overtime.register.action.ExportOvertimeAction)context.get("ExportAction");
  nc.ui.ta.overtime.register.action.ExportOvertimeAction bean = new nc.ui.ta.overtime.register.action.ExportOvertimeAction();
...
public nc.funcnode.ui.action.GroupAction getCheckgroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("Checkgroup");
  ...
  bean.setCode("check");
  bean.setName(getI18nFB_1f65464());
...
private java.lang.String getI18nFB_1f65464(){
 if(context.get("nc.ui.uif2.I18nFB#1f65464")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1f65464");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1f65464",bean);  bean.setResDir("6017basedoc");
  bean.setDefaultValue("校验");
  bean.setResId("06017basedoc1722");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1f65464",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList9(){  List list = new ArrayList();  list.add(getCheckAction());  list.add(getUnCheckAction());  return list;}
...
public nc.funcnode.ui.action.GroupAction getRestgroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("Restgroup");
  ...
  bean.setCode("rest");
  bean.setName(getI18nFB_11eadbc());
...
private java.lang.String getI18nFB_11eadbc(){
 if(context.get("nc.ui.uif2.I18nFB#11eadbc")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#11eadbc");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#11eadbc",bean);  bean.setResDir("6017basedoc");
  bean.setDefaultValue("转调休");
  bean.setResId("06017basedoc1730");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#11eadbc",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList10(){  List list = new ArrayList();  list.add(getRestAction());  list.add(getUnRestAction());  return list;}
...
public nc.funcnode.ui.action.GroupAction getPrintGroupAction(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("PrintGroupAction");
  ...
  bean.setName(getI18nFB_12052d7());
...
private java.lang.String getI18nFB_12052d7(){
 if(context.get("nc.ui.uif2.I18nFB#12052d7")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#12052d7");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#12052d7",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#12052d7",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList11(){  List list = new ArrayList();  list.add(getPrintDirectAction());  list.add(getPrintPreviewAction());  list.add(getOutputAction());  list.add(getSeparatorAction());  list.add(getTemplatePrintAction());  list.add(getTemplatePreviewAction());  return list;}
...
public nc.funcnode.ui.action.GroupAction getCardPrintActiongroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("CardPrintActiongroup");
  ...
  bean.setName(getI18nFB_11ebd87());
...
private java.lang.String getI18nFB_11ebd87(){
 if(context.get("nc.ui.uif2.I18nFB#11ebd87")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#11ebd87");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#11ebd87",bean);  bean.setResDir("common");
  bean.setDefaultValue("打印");
  bean.setResId("UC001-0000007");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#11ebd87",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList12(){  List list = new ArrayList();  list.add(getTemplatePrintAction());  list.add(getTemplatePreviewAction());  list.add(getCardOutputAction());  return list;}
