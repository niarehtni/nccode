...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getCNode_294d5f());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_294d5f(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#294d5f")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#294d5f");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#294d5f",bean);
...
private List getManagedList0(){  List list = new ArrayList();  list.add(getRefreshAction());  list.add(getSeparatorAction());  list.add(getInitPeriodAction());  list.add(getSeparatorAction());  list.add(getInitTaxAction());  list.add(getSeparatorAction());  list.add(getInitItemAction());  list.add(getSeparatorAction());  list.add(getInitClassItemAction());  list.add(getSeparatorAction());  list.add(getUnInitAction());  list.add(getSeparatorAction());  list.add(getDeductionUpgradeAction());  return list;}
