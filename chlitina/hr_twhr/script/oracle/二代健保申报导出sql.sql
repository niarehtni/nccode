...
Insert into WA_EXPFORMAT_ITEM
(pk_formathead,pk_formatitem,linenumber,posnumber,itemcode,itemname,datatype,byteLength,fillmode,fillstr,prefix,suffix,splitter,issum,datasource,datatable,joinkey,datacontext,ts,dr)
Values('6886TW10000FUBON2018','6886TW10000SECON0019',2,9,'SINGLEPAY','所得(收入)給付金額',1,14,1,'0','','','','N',2,'','','dpart.single_pay','2018-09-27 20:02:33',0);

Insert into WA_EXPFORMAT_ITEM
(pk_formathead,pk_formatitem,linenumber,posnumber,itemcode,itemname,datatype,byteLength,fillmode,fillstr,prefix,suffix,splitter,issum,datasource,datatable,joinkey,datacontext,ts,dr)
Values('6886TW10000FUBON2018','6886TW10000SECON0020',2,10,'WITHHOLDING','扣繳補充保費金額',1,10,1,'0','','','','N',2,'','','dpart.single_withholding','2018-09-27 20:02:33',0);
...
Insert into WA_EXPFORMAT_ITEM
(pk_formathead,pk_formatitem,linenumber,posnumber,itemcode,itemname,datatype,byteLength,fillmode,fillstr,prefix,suffix,splitter,issum,datasource,datatable,joinkey,datacontext,ts,dr)
Values('6886TW10000FUBON2018','6886TW10000SECON0022',2,12,'MONTHAMOUNT','扣費當月投保金額',1,6,1,'0','','','','N',2,'','','dpart.totalbonusforyear','2018-09-27 20:02:33',0);

Insert into WA_EXPFORMAT_ITEM
(pk_formathead,pk_formatitem,linenumber,posnumber,itemcode,itemname,datatype,byteLength,fillmode,fillstr,prefix,suffix,splitter,issum,datasource,datatable,joinkey,datacontext,ts,dr)
Values('6886TW10000FUBON2018','6886TW10000SECON0023',2,13,'UNITAMOUNT','同年度累積金額',1,10,1,'','','','','N',2,'','','dpart.deductions_month_insure','2018-09-27 20:02:33',0);
...
Insert into WA_EXPFORMAT_ITEM
(pk_formathead,pk_formatitem,linenumber,posnumber,itemcode,itemname,datatype,byteLength,fillmode,fillstr,prefix,suffix,splitter,issum,datasource,datatable,joinkey,datacontext,ts,dr)
Values('6886TW10063FUBON2018','6886TW10000SECON0120',2,10,'WITHHOLDING','扣繳補充保費金額',1,10,1,'0','','','','N',2,'','','dpart.single_withholding','2018-09-27 20:02:33',0);
...
Insert into WA_EXPFORMAT_ITEM
(pk_formathead,pk_formatitem,linenumber,posnumber,itemcode,itemname,datatype,byteLength,fillmode,fillstr,prefix,suffix,splitter,issum,datasource,datatable,joinkey,datacontext,ts,dr)
Values('6886TW10063FUBON2018','6886TW10000SECON0219',2,9,'SINGLEPAY','所得(收入)給付金額',1,14,1,'0','','','','N',2,'','','dpart.single_pay','2018-09-27 20:02:33',0);
...
Insert into WA_EXPFORMAT_ITEM
(pk_formathead,pk_formatitem,linenumber,posnumber,itemcode,itemname,datatype,byteLength,fillmode,fillstr,prefix,suffix,splitter,issum,datasource,datatable,joinkey,datacontext,ts,dr)
Values('6886TW10065FUBON2018','6886TW10000SECON1120',2,10,'WITHHOLDING','扣繳補充保費金額',1,10,1,'0','','','','N',2,'','','dpart.single_withholding','2018-09-27 20:02:33',0);
...
Insert into WA_EXPFORMAT_ITEM
(pk_formathead,pk_formatitem,linenumber,posnumber,itemcode,itemname,datatype,byteLength,fillmode,fillstr,prefix,suffix,splitter,issum,datasource,datatable,joinkey,datacontext,ts,dr)
Values('6886TW10065FUBON2018','6886TW10000SECON1219',2,9,'SINGLEPAY','所得(收入)給付金額',1,14,1,'0','','','','N',2,'','','dpart.single_pay','2018-09-27 20:02:33',0);
...
Insert into WA_EXPFORMAT_ITEM
(pk_formathead,pk_formatitem,linenumber,posnumber,itemcode,itemname,datatype,byteLength,fillmode,fillstr,prefix,suffix,splitter,issum,datasource,datatable,joinkey,datacontext,ts,dr)
Values('6886TW10065FUBON2018','6886TW10000SECON1634',3,6,'SUM_WITHHOLDING','扣繳補衝保費總額',0,16,1,'0','','','','N',2,'','','%SUM:LINE:2:WITHHOLDING%','2018-09-27 20:02:33',0);
