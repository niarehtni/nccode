package nc.ui.trn.dimissionrds.view;
 ...
 * 劳健保日期選擇對話框
 */
public class DateLarborDlg extends HrDialog implements PropertyChangeListener {
	 ...
	 * @param parent
	 */
	public DateLarborDlg(Container parent, String title,String desc) {
