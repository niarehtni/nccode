...
ALTER TABLE
    tbm_timerule ADD isrestrictctrlot3 char(1);
ALTER TABLE
    tbm_timerule ADD ctrlothours1of3 DECIMAL(28,8);
ALTER TABLE
    tbm_timerule ADD isrestrictctrlot1of3 char(1);
ALTER TABLE
...
ALTER TABLE
    tbm_timerule ADD isautotransfersalary char(1);
	
--增補加班類別字段
ALTER TABLE
    tbm_timeitemcopy ADD isstuffdecidecomp char(1) DEFAULT 'Y';
ALTER TABLE
    tbm_timeitemcopy ADD daylimit DECIMAL(10,4) DEFAULT 0;
ALTER TABLE
    tbm_timeitemcopy ADD isincludewithlimit char(1) DEFAULT 'N';
ALTER TABLE
...
ALTER TABLE
    tbm_timeitemcopy ADD pk_segrule char(20);
ALTER TABLE
    tbm_timeitemcopy ADD date_type INT;
ALTER TABLE
    tbm_timeitemcopy ADD isdatetypedefault char(1) DEFAULT 'N';
