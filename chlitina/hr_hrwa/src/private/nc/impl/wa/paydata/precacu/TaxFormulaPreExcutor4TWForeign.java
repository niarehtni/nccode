...
public class TaxFormulaPreExcutor4TWForeign extends AbstractFormulaExecutor {
    ...
    @Override
    public void excute(Object paramObject, WaLoginContext context) throws BusinessException {
	// 查询出税率表为外籍员工税率表的所有员工
	...
	for (int i = 0; i < psnList.size(); i++) {
	    ...
	    String isResident = psnVo.getAttributeValue(LocalizationSysinitUtil.getTwhrlPsn("TWHRLPSN02")) != null ? psnVo
     ...
     */
    private boolean isExpire(String twhr08, UFDouble expireNum, PsndocVO psn, WaLoginContext context)
	    throws BusinessException {
