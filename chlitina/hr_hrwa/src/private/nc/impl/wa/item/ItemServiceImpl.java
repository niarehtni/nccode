...
public class ItemServiceImpl implements IItemManageService, IItemQueryService,
	...
	private WaItemVO[] batchFillTotalItem(WaItemVO[] itemVOs)
		...
		for (WaItemVO itemVO : itemVOs) {
			...
			sbSql.append("select isnhiitem_30, ishealthinsexsum_30 ,ishealthinsparttime from twhr_waitem_30 where pk_wa_item='"
			...
			itemVO.setIshealthinsparttime(UFBoolean.valueOf((String) values
					.get(0).get("ishealthinsparttime")));
			// end
		}
