...
public class SelPsnPanelForAddJoin extends UIPanel implements ICompWithValidateFunc,AppEventListener, ValueChangedListener {
	...
	public void init(){
		...
		add(getSelPsnPanelForAddJoin(), BorderLayout.CENTER);
	}
...
//	}
	...
	protected ConditionSelPsnPanel getSelPsnPanelForAddJoin(){
		if(selPanel == null){
