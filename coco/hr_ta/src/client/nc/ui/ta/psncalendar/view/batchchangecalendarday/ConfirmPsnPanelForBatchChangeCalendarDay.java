...
public class ConfirmPsnPanelForBatchChangeCalendarDay extends UIPanel {
	...
	public ConfirmPsnPanelForBatchChangeCalendarDay() {
	...
	protected BillListPanel getBillListPanel() {
		if(billListPanel==null){
			...
			BillTempletVO btv = PsnTempletUtils.createSeniorItems(IBillItem.HEAD);
