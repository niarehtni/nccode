...
<PageMeta caption="店员签卡登记列表" componentId="annoyuicomponnet" controllerClazz="nc.bs.hrsms.ta.SignReg.ctrl.SignRegListWinController" id="SignRegList" sourcePackage="ta/src/public/">
        ...
        <Widget canFreeDesign="false" id="pubview_simplequery" refId="../pubview_simplequery">
        	<Attributes>
                <Attribute>
                    ...
                    <Value>
                    	nc.bs.hrsms.ta.SignReg.ctrl.SignRegListQueryCtrl
                    </Value>
                    <Desc>
                    </Desc>
                </Attribute>
