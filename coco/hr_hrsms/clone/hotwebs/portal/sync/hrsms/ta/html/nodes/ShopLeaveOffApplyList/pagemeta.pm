...
<PageMeta i18nName="" langDir="" caption="店员休假申请列表界面" controllerClazz="nc.bs.hrsms.ta.sss.leaveoff.ctrl.ShopLeaveOffApplyListWin" id="ShopLeaveOffApplyList" sourcePackage="src/public/" windowType="win">
    <Processor>nc.uap.lfw.core.event.AppRequestProcessor</Processor>
    <Widgets>
        <Widget canFreeDesign="true" id="main" refId="main">
        </Widget>
        <Widget canFreeDesign="true" id="reglist" refId="reglist">
        </Widget>
