...
<PageMeta i18nName="a_pub-000198" langDir="node_pub-res" caption="店员出勤情况列表界面" controllerClazz="nc.bs.hrsms.ta.sss.ShopAttendance.ctrl.ShopAttendanceMngWin" id="ShopAttendanceMng" sourcePackage="src/public/" windowType="win">
        ...
        <Widget canFreeDesign="false" id="pubview_simplequery" refId="../pubview_simplequery">
            <Attributes>
                <Attribute>
                    ...
                    <Value>nc.bs.hrsms.ta.sss.ShopAttendance.ctrl.ShopAttendanceMngQueryCtrl</Value>
                    <Desc>
                    </Desc>
                </Attribute>
            </Attributes>
