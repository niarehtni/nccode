...
<PageMeta i18nName="" langDir="" caption="店员加班登记列表界面" controllerClazz="nc.bs.hrsms.ta.sss.overtime.ctrl.ShopOverTimeRegListWin" id="ShopOverTimeRegList" sourcePackage="src/public/" windowType="win">
        ...
        <Widget canFreeDesign="false" id="pubview_simplequery" refId="../pubview_simplequery">
        	<Attributes>
                <Attribute>
                    ...
                    <Value>
                    	nc.bs.hrsms.ta.sss.common.ShopTaRegListQueryCtrl
                    </Value>
                    <Desc>
                    </Desc>
                </Attribute>
