...
public class BatchChangeShiftPageModel extends AdvancePageModel {
	/* 人员信息集 */
	...
	public void setShiftRefNode(){
		...
		NCRefNode oldShiftRfnodeGrade = (NCRefNode) widget.getViewModels().getRefNode("refOriClass");
		oldShiftRfnodeGrade.setDataListener(BURefController.class.getName());
	}
