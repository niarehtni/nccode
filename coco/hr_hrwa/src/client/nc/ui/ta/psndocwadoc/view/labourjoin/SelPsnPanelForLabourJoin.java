...
public class SelPsnPanelForLabourJoin extends UIPanel implements ICompWithValidateFunc,AppEventListener, ValueChangedListener {
	...
	public SelPsnPanelForLabourJoin() {
	...
	public void init(){
		...
		add(getSelPsnPanelForLabourJoin(), BorderLayout.CENTER);
	}
...
//	}
	...
	protected ConditionSelPsnPanel getSelPsnPanelForLabourJoin(){
		if(selPanel == null){
