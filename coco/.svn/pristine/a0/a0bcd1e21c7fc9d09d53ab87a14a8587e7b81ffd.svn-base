...
<PageMeta i18nName="" langDir="" caption="店员加班登记详细界面" controllerClazz="nc.bs.hrsms.ta.sss.overtime.ctrl.ShopOverTimeRegCardWin" id="ShopOverTimeRegCard" sourcePackage="src/public/" windowType="win">
