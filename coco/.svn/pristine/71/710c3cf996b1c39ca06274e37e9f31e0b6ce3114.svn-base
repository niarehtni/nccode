...
public class ShiftSetPanelForBatchChangeDayType extends UIPanel  implements ValueChangedListener, AppEventListener,  ActionListener {
	...
	public ShiftSetPanelForBatchChangeDayType() {
