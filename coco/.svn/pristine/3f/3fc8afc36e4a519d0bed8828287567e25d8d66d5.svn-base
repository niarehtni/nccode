...
<PageMeta i18nName="" langDir="" caption="店员出差登记列表界面" controllerClazz="nc.bs.hrsms.ta.sss.away.ctrl.ShopAwayRegListWin" id="ShopAwayRegList" sourcePackage="src/public/" windowType="win">
        ...
        <Widget canFreeDesign="false" id="pubview_simplequery" refId="../pubview_simplequery">
        	<Attributes>
                <Attribute>
                    ...
                    <Value>
                    	nc.bs.hrsms.ta.sss.common.AwayRegListQueryCtrl
                    </Value>
                    <Desc>
                    </Desc>
                </Attribute>
