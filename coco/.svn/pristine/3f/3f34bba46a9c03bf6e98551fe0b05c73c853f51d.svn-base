...
<PageMeta i18nName="" langDir="" caption="店员出差申请列表界面" controllerClazz="nc.bs.hrsms.ta.sss.away.ctrl.ShopAwayApplyListWin" id="ShopAwayApplyList" sourcePackage="src/public/" windowType="win">
