...
public class DataInterface_Config extends AbstractJavaBeanDefinition {
	...
	public nc.ui.uif2.TangramContainer getMainPanel() {
		...
		bean.setTangramLayoutRoot(getVSNode_1e60fb6());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1e60fb6() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#1e60fb6") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context.get("nc.ui.uif2.tangramlayout.node.VSNode#1e60fb6");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#1e60fb6", bean);
		bean.setUp(getCNode_48da47());
		bean.setDown(getCNode_f27ce6());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_48da47() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#48da47") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#48da47");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#48da47", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_f27ce6() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#f27ce6") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#f27ce6");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#f27ce6", bean);
	...
	public nc.ui.uif2.TangramContainer getIoPanel() {
		...
		bean.setTangramLayoutRoot(getVSNode_e29e0e());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_e29e0e() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#e29e0e") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context.get("nc.ui.uif2.tangramlayout.node.VSNode#e29e0e");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#e29e0e", bean);
		bean.setUp(getCNode_1119058());
		bean.setDown(getCNode_1ba4d5());
		bean.setDividerLocation(30f);
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_1119058() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1119058") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#1119058");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#1119058", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_1ba4d5() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1ba4d5") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#1ba4d5");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#1ba4d5", bean);
	...
	public nc.ui.uif2.TangramContainer getBankPanel() {
		...
		bean.setTangramLayoutRoot(getVSNode_be5d1d());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_be5d1d() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#be5d1d") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context.get("nc.ui.uif2.tangramlayout.node.VSNode#be5d1d");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#be5d1d", bean);
		bean.setUp(getCNode_1f6c33b());
		bean.setDown(getCNode_18b753e());
		bean.setDividerLocation(30f);
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_1f6c33b() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1f6c33b") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#1f6c33b");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#1f6c33b", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_18b753e() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#18b753e") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#18b753e");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#18b753e", bean);
	...
	public nc.funcnode.ui.action.GroupAction getPrintActionMenu() {
		...
		bean.setCode("print");
		bean.setName(getI18nFB_1d33f33());
	...
	private java.lang.String getI18nFB_1d33f33() {
		if (context.get("nc.ui.uif2.I18nFB#1d33f33") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#1d33f33");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#1d33f33", bean);
		...
		try {
			...
			context.put("nc.ui.uif2.I18nFB#1d33f33", product);
	...
	public nc.funcnode.ui.action.MenuAction getFipAndExportActionMenu() {
		...
		bean.setName(getI18nFB_17fffaa());
	...
	private java.lang.String getI18nFB_17fffaa() {
		if (context.get("nc.ui.uif2.I18nFB#17fffaa") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#17fffaa");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#17fffaa", bean);
		bean.setResDir("xmlcode");
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#17fffaa", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
