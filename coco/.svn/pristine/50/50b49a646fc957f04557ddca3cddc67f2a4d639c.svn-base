...
<PageMeta i18nName="" langDir="" caption="批量出差登记详细界面" controllerClazz="nc.bs.hrsms.ta.sss.away.ctrl.ShopAwayRegBatchCardWin" id="ShopAwayRegBatchCard" sourcePackage="src/public/" windowType="win">
