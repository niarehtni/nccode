...
import nc.ui.ta.pub.standardpsntemplet.PsnTempletAddUtils;
import nc.vo.pub.SuperVO;
import nc.vo.pub.bill.BillTempletVO;
import nc.vo.ta.psndoc.TBMPsndocVO;

@SuppressWarnings("restriction")
public class ConfirmPsnPanelForAddJoin extends UIPanel {
	...
	public ConfirmPsnPanelForAddJoin() {
	...
	protected BillListPanel getBillListPanel() {
		if(billListPanel==null){
			...
			BillTempletVO btv = PsnTempletAddUtils.createSeniorItems(IBillItem.HEAD);
