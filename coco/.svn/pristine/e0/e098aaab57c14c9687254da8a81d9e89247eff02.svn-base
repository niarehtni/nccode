...
public class DataInterface_Config extends AbstractJavaBeanDefinition {
	...
	public nc.ui.uif2.TangramContainer getMainPanel() {
		...
		bean.setTangramLayoutRoot(getVSNode_1b315e3());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1b315e3() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#1b315e3") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context
					.get("nc.ui.uif2.tangramlayout.node.VSNode#1b315e3");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#1b315e3", bean);
		bean.setUp(getCNode_1257c08());
		bean.setDown(getCNode_1f2033e());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_1257c08() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1257c08") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#1257c08");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#1257c08", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_1f2033e() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1f2033e") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#1f2033e");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#1f2033e", bean);
	...
	public nc.ui.uif2.TangramContainer getIoPanel() {
		...
		bean.setTangramLayoutRoot(getVSNode_f444b1());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_f444b1() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#f444b1") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context
					.get("nc.ui.uif2.tangramlayout.node.VSNode#f444b1");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#f444b1", bean);
		bean.setUp(getCNode_620edb());
		bean.setDown(getCNode_1bd6bdc());
		bean.setDividerLocation(30f);
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_620edb() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#620edb") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#620edb");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#620edb", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_1bd6bdc() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1bd6bdc") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#1bd6bdc");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#1bd6bdc", bean);
	...
	public nc.ui.uif2.TangramContainer getBankPanel() {
		...
		bean.setTangramLayoutRoot(getVSNode_1916b13());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1916b13() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#1916b13") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context
					.get("nc.ui.uif2.tangramlayout.node.VSNode#1916b13");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#1916b13", bean);
		bean.setUp(getCNode_c9cb36());
		bean.setDown(getCNode_3c5f40());
		bean.setDividerLocation(30f);
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_c9cb36() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#c9cb36") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#c9cb36");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#c9cb36", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_3c5f40() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#3c5f40") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#3c5f40");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#3c5f40", bean);
	...
	private java.lang.String getI18nFB_ce391() {
		if (context.get("nc.ui.uif2.I18nFB#ce391") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#ce391");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#ce391", bean);
		...
		try {
			...
			context.put("nc.ui.uif2.I18nFB#ce391", product);
	...
	public nc.funcnode.ui.action.MenuAction getFipAndExportActionMenu() {
		...
		bean.setName(getI18nFB_1d294b3());
	...
	private java.lang.String getI18nFB_1d294b3() {
		if (context.get("nc.ui.uif2.I18nFB#1d294b3") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#1d294b3");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#1d294b3", bean);
		bean.setResDir("xmlcode");
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#1d294b3", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
