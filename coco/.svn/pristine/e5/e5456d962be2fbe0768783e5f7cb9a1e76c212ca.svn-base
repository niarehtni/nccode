...
<PageMeta i18nName="a_pub-000176" langDir="node_pub-res" caption="店员假期查询列表界面" controllerClazz="nc.bs.hrsms.ta.sss.leaveinfo.ctrl.LeaveInfoQryWin" id="LeaveInfoForMng" sourcePackage="src/public/" windowType="win">
        ...
        <Widget canFreeDesign="false" id="pubview_simplequery" refId="../pubview_simplequery">
            <Attributes>
                <Attribute>
                    ...
                    <Value>nc.bs.hrsms.ta.sss.leaveinfo.ctrl.LeaveInfoQryQueryCtrl</Value>
                    <Desc>
                    </Desc>
                </Attribute>
            </Attributes>
