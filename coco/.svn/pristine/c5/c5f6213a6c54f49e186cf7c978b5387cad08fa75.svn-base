...
<PageMeta i18nName="" langDir="" caption="店员批量加班登记" controllerClazz="nc.bs.hrsms.ta.sss.overtime.ctrl.ShopOverTimeRegBatchCardWin" id="ShopOverTimeRegBatchCard" sourcePackage="src/public/" windowType="win">
