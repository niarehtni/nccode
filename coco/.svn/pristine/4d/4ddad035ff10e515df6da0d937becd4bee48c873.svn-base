...
<PageMeta i18nName="" langDir="" caption="店员工作日历按日历查看界面" controllerClazz="nc.bs.hrsms.ta.sss.calendar.ctrl.WorkCalendarListWin" id="WorkCalendarForPsn" sourcePackage="src/public/" windowType="win">
