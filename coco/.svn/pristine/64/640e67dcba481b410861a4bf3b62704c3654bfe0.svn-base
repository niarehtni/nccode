...
import nc.impl.ta.dataprocess.customization.ext.DealWithTimeDataForTW_Taylor;
...
//		}
		...
		//MOD 运算前对刷签卡记录进行调整，打卡时间只精确到分钟，需要将秒钟抹去, James 2018-09-29
		DealWithTimeDataForTW_Taylor dwtdftw = new DealWithTimeDataForTW_Taylor();
		dwtdftw.dealWithCheckTimes(para.pk_org, para.allCheckTimes);
