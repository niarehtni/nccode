...
//			isYear = leavesetperiod!=null&&(Integer)SettlementPeriodEnum.YEAR.value()==leavesetperiod.intValue();
//			isYear = leavesetperiod!=null&&(TimeItemCopyVO.LEAVESETPERIOD_YEAR==leavesetperiod||TimeItemCopyVO.LEAVESETPERIOD_DATE==leavesetperiod);
...
/*@res "年度"*/);
	...
	public void initYearComboBox(){
		try {
			...
			Object data = getHierachicalModel().getSelectedData();
//			boolean isDate = data!=null&&(data instanceof LeaveTypeCopyVO)&&((LeaveTypeCopyVO)data).getLeavesetperiod().intValue()==LeaveTypeCopyVO.LEAVESETPERIOD_DATE;
