		...
		if (vos != null && vos.length > 0) {
			for (TimeItemCopyVO vo : vos) {
				...
				if (vo.getItemtype() == TimeItemCopyVO.OVERTIME_TYPE) {
					try {
						if (isTWOrg(pk_org)) {
							if ("1002Z710000000021ZLT".equals(vo
									.getPk_timeitem())) {// 平日加班
								Content cont = new Content();
								contentList.add(cont);
								String contName = ResHelper.getString(
										"6017basedoc", "2basedocext-000004");

								cont.setContentName(MessageFormat.format(
										contName, vo.getMultilangName()));
								cont.setColName("overtime_notcurrmonth_.WorkFirst2H."
										+ vo.getPk_timeitem());

								Content cont1 = new Content();
								contentList.add(cont1);
								String contName1 = ResHelper.getString(
										"6017basedoc", "2basedocext-000005");
								cont1.setContentName(MessageFormat.format(
										contName1, vo.getMultilangName()));
								cont1.setColName("overtime_notcurrmonth_.WorkLast2H."
										+ vo.getPk_timeitem());
							} else if ("1002Z710000000021ZLX".equals(vo
									.getPk_timeitem())) {// 国定假日加班
								Content cont = new Content();
								contentList.add(cont);
								String contName = ResHelper.getString(
										"6017basedoc", "2basedocext-000006");

								cont.setContentName(MessageFormat.format(
										contName, vo.getMultilangName()));
								cont.setColName("overtime_notcurrmonth_.HolidayFirst8H."
										+ vo.getPk_timeitem());

								Content cont1 = new Content();
								contentList.add(cont1);
								String contName1 = ResHelper.getString(
										"6017basedoc", "2basedocext-000007");
								cont1.setContentName(MessageFormat.format(
										contName1, vo.getMultilangName()));
								cont1.setColName("overtime_notcurrmonth_.Holiday8To12H."
										+ vo.getPk_timeitem());

								Content cont2 = new Content();
								contentList.add(cont2);
								String contName2 = ResHelper.getString(
										"6017basedoc", "2basedocext-000008");
								cont2.setContentName(MessageFormat.format(
										contName2, vo.getMultilangName()));
								cont2.setColName("overtime_notcurrmonth_.HolidayAfter12H."
										+ vo.getPk_timeitem());
							} else if ("1002Z710000000021ZLV".equals(vo
									.getPk_timeitem())) {// 休息日加班
								Content cont = new Content();
								contentList.add(cont);
								String contName = ResHelper.getString(
										"6017basedoc", "2basedocext-000009");

								cont.setContentName(MessageFormat.format(
										contName, vo.getMultilangName()));
								cont.setColName("overtime_notcurrmonth_.RestFirst2H."
										+ vo.getPk_timeitem());

								Content cont1 = new Content();
								contentList.add(cont1);
								String contName1 = ResHelper.getString(
										"6017basedoc", "2basedocext-000010");
								cont1.setContentName(MessageFormat.format(
										contName1, vo.getMultilangName()));
								cont1.setColName("overtime_notcurrmonth_.Rest2To8H."
										+ vo.getPk_timeitem());

								Content cont2 = new Content();
								contentList.add(cont2);
								String contName2 = ResHelper.getString(
										"6017basedoc", "2basedocext-000011");
								cont2.setContentName(MessageFormat.format(
										contName2, vo.getMultilangName()));
								cont2.setColName("overtime_notcurrmonth_.RestAfter8H."
										+ vo.getPk_timeitem());
							}
							...
							contentList.add(cont);
							String contName = ResHelper.getString(
									"6017basedoc", "2basedocext-000002")
							/* @res "{0}非当月单据当月审批" */;
							cont.setContentName(MessageFormat.format(contName,
									vo.getMultilangName()));
							cont.setColName("overtime_notcurrmonth_."
									+ vo.getPk_timeitem());
						}
					} catch (BusinessException e) {
				...
				if (vo.getItemtype() == TimeItemCopyVO.OVERTIME_TYPE) {
					...
					cont.setContentName(MessageFormat.format(contName,
							vo.getMultilangName()));
					cont.setColName("_OVER_TO_RESTovertime_notcurrmonth_."
							+ vo.getPk_timeitem());
				}
				...
				content.setColName("_OVERTIME_ACTUAL_HOUR" + vo.getPk_timeitem());
