...
public class PeriodChooseDlg extends HrDialog implements PropertyChangeListener {
	...
	public UILabel getLblBaseDate() {
		if (lblBaseDate == null) {
			...
			lblBaseDate.setText(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes()
					.getStrByID("twhr_personalmgt", "068J61035-0088")/*
																	 * @res 基准日期
																	 */);
		}
	...
	public UILabel getLblAvgMonCount() {
		if (lblAvgMonCount == null) {
			...
			lblAvgMonCount.setText(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes()
					.getStrByID("twhr_personalmgt", "068J61035-0089")/*
																	 * @res 平均月数
																	 */);
		}
			...
			MessageDialog.showErrorDlg(
					...
					nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID(
							...
							+ nc.vo.ml.NCLangRes4VoTransl.getNCLangRes()
									.getStrByID("twhr_personalmgt",
											"068J61035-0027")/* 不能为空 */);
		} else if (StringUtils.isEmpty( this.getRefBaseDate().getValueObj()
				.toString())) {
			MessageDialog.showErrorDlg(
					this.getOwner(),
					nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID(
							"twhr_personalmgt", "068J61035-0026")/* 提示 */,
					nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID(
							"twhr_personalmgt", "068J61035-0033")/* 基准日期 */
							+ nc.vo.ml.NCLangRes4VoTransl.getNCLangRes()
									.getStrByID("twhr_personalmgt",
											"068J61035-0027")/* 不能为空 */);
		}/* else if (StringUtils.isEmpty( (String) this.getRefAvgMonCount().getRefModel().getValue("0"))) {
			MessageDialog.showErrorDlg(
					this.getOwner(),
					nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID(
							"twhr_personalmgt", "068J61035-0026") 提示 ,
		...
		layout.setHorizontalGroup(layout
				...
				.add(layout
						...
						.add(layout
								...
								.add(layout
										.createSequentialGroup()
										.add(this.getLblAvgMonCount())
										.addPreferredGap(0)
										.add(this.getRefAvgMonCount(),
												GroupLayout.PREFERRED_SIZE,
												200, GroupLayout.PREFERRED_SIZE))
								.add(layout
										.createSequentialGroup()
