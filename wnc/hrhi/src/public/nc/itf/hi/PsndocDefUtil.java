...
public class PsndocDefUtil {
	...
	if (classMap == null) {
	    ...
	    strSQL += "          '1001ZZ10000000002PZV', '1001ZZ10000000002U2R', 'TWHRA21000000000DEF5', 'TWHRA21000000000DEF6')";
	...
	if (getClassMap() != null) {
	    return (PsndocDefVO) getPsndocDefVOByClassname(getClassMap().get("1001ZZ10000000001PQV"));
	}
	...
	if (getClassMap() != null) {
	    return (PsndocDefVO) getPsndocDefVOByClassname(getClassMap().get("1001ZZ10000000001Q7R"));
	}
	...
	if (getClassMap() != null) {
	    return (PsndocDefVO) getPsndocDefVOByClassname(getClassMap().get("1001ZZ10000000002PZV"));
	}
	...
	if (getClassMap() != null) {
	    return (PsndocDefVO) getPsndocDefVOByClassname(getClassMap().get("1001ZZ10000000002U2R"));
	}
	...
	if (getClassMap() != null) {
	    return (PsndocDefVO) getPsndocDefVOByClassname(getClassMap().get("TWHRA21000000000DEF5"));
	}
	...
	if (getClassMap() != null) {
	    return (PsndocDefVO) getPsndocDefVOByClassname(getClassMap().get("TWHRA21000000000DEF6"));
	}
