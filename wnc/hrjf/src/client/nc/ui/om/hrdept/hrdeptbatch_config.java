...
import nc.ui.om.hrdept.action.FlashInnercodeAction;
...
public class hrdeptbatch_config extends AbstractJavaBeanDefinition {
	...
	private java.lang.String getI18nFB_4cc12db2() {
		...
		context.put("&nc.ui.uif2.I18nFB#4cc12db2", bean);
	...
	private List getManagedList1() {
		...
		list.add(getCopyLineAction());
		list.add(getPasteLineAction());
		return list;
	}
	...
	public java.lang.String getResourceCode() {
		...
		java.lang.String bean = new java.lang.String("60050deptinfo");
	...
	public FlashInnercodeAction getFlashInnercodeAction() {
		if (this.context.get("flashInnercodeAction") != null) {
			return (FlashInnercodeAction) this.context.get("flashInnercodeAction");
		}
		FlashInnercodeAction bean = new FlashInnercodeAction();
		this.context.put("flashInnercodeAction", bean);
		bean.setModel(getManageAppModel());
		bean.setBtnName("刷新Innercode");
		bean.setModel(getManageAppModel());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private java.lang.String getI18nFB_6c4ce583() {
		...
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#6c4ce583", bean);
		bean.setResDir("menucode");
	...
	private List getManagedList2() {
		List list = new ArrayList();
		list.add(getCreateDeptStruVersionAction());
		list.add(getCreateDeptVersionAction());
		return list;
	}
	...
	private java.lang.String getI18nFB_755b5f30() {
		...
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#755b5f30", bean);
		bean.setResDir("menucode");
	...
	private java.lang.String getI18nFB_29bbc63c() {
		...
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#29bbc63c", bean);
		bean.setResDir("menucode");
		bean.setDefaultValue("过滤");
	...
	private List getManagedList3() {
		List list = new ArrayList();
		list.add(getShowHRCanceledDataAction());
		list.add(getShowHRFutureDataAction());
		return list;
	}
	...
	private java.lang.String getI18nFB_272778ae() {
		...
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#272778ae", bean);
		bean.setResDir("menucode");
	...
	private List getManagedList4() {
		List list = new ArrayList();
		list.add(getHRCancelAction());
		list.add(getHRUnCancelAction());
		return list;
	}
	...
	private java.lang.String getI18nFB_2cccf134() {
		...
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#2cccf134", bean);
		bean.setResDir("menucode");
	...
	private java.lang.String getI18nFB_3c18942() {
		...
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#3c18942", bean);
		bean.setResDir("menucode");
		bean.setDefaultValue("变更");
		bean.setResId("X600511");
		setBeanFacotryIfBeanFacatoryAware(bean);
	...
	private java.lang.String getI18nFB_743c3520() {
		...
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#743c3520", bean);
		bean.setResDir("menucode");
	...
	private List getManagedList8() {
		List list = new ArrayList();
		list.add(getQueryPostAction());
		list.add(getQueryPersonAction());
		return list;
	}
	...
	public nc.ui.om.pub.validator.OMBillNotNullValidateService getBillNotNullValidator() {
		...
		nc.ui.om.pub.validator.OMBillNotNullValidateService bean = new nc.ui.om.pub.validator.OMBillNotNullValidateService(
				getBillFormEditor(), "pk_vid");
	...
	private List getManagedList9() {
		...
		list.add(getCopyDeptAction());
		list.add(getNullaction());
		list.add(getQueryAction());
		list.add(getRefreshAction());
		list.add(getFilterAction());
		list.add(getNullaction());
		list.add(getAlterationGroupAction());
		list.add(getVersionAction());
		list.add(getFileManageAction());
		list.add(getNullaction());
		list.add(getAssiciatedQueryAction());
		list.add(getNullaction());
		list.add(getPrintGroupAction());
		list.add(getNullaction());
		list.add(getCheckVersionErrorAction());
		// list.add(getFlashInnercodeAction());
		return list;
	}
