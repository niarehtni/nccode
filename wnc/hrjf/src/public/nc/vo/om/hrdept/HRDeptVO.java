...
public class HRDeptVO extends DeptVO {
	...
	/*
	 * public void setDepthistory(DeptHistoryVO[] depthistory) { //
	 * 在设定前首先要按照生效日期的倒序排序 if (!ArrayUtils.isEmpty(depthistory)) {
	 * SuperVOHelper.sort(depthistory, new String[] { DeptHistoryVO.EFFECTDATE
	 * }, new boolean[] { true }, false); } this.depthistory = depthistory; }
	 */

	/*
	 * public DeptManager[] getDeptmanager() { return deptmanager; } public void
	 * setDeptmanager(DeptManager[] deptmanager) { this.deptmanager =
	 * deptmanager; } public DeptOtherVO[] getDeptother() { return deptother; }
	 * public void setDeptother(DeptOtherVO[] deptother) { this.deptother =
	 * deptother; }
	 */
	...
	/*
	 * @Override public void setAttributeValue(String name, Object value) { if
	 * ("depthistory".equals(name)) { setDepthistory((DeptHistoryVO[]) value);
	 * return; } else if ("deptmanager".equals(name)) {
	 * setDeptmanager((DeptManager[]) value); return; } else if
	 * ("deptother".equals(name)) { setDeptother((DeptOtherVO[]) value); return;
