...
public class LeaveTypeSalaryHourParse extends AbstractPreExcutorFormulaParse {
	...
	public void excute(Object formula, WaLoginContext waLoginContext) throws BusinessException {
		...
		if (rows == 0) {
			...
			try {
				...
				// 取本次計算的人員列表
				String psnlistsql = "select DISTINCT pk_psndoc from wa_cacu_data where pk_wa_class= '"
