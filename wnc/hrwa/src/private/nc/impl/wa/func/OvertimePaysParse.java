...
import nc.impl.wa.paydata.precacu.OvertimePaysPreExcutor;
...
public class OvertimePaysParse extends AbstractWAFormulaParse {
	...
	public FunctionReplaceVO getReplaceStr(String formula)
		...
		IFormula excutor = new OvertimePaysPreExcutor();
