...
public class DaySalaryFormulaPreExcutor extends AbstractPreExcutorFormulaParse {
	...
	public void excute(Object formula, WaLoginContext context)
		...
		String pk_wa_item = getItemPkByItemKey(arguments[0]);
		...
		Map<String, UFDouble> psnSalaryMap = lookup(IWadaysalaryQueryService.class)
				.getTotalDaySalaryMapByWaItem(psndocs, context.getPk_wa_class(), cyear, cperiod, pk_wa_item);
		...
		try {
			...
			Iterator<Map.Entry<String, UFDouble>> iterator = psnSalaryMap
					.entrySet().iterator();
