...
public class Paydata_Config extends AbstractJavaBeanDefinition {
	...
	private nc.ui.wa.paydata.view.WaPaydataQueryDelegator getWaPaydataQueryDelegator_6c6cee84() {
		if (context.get("nc.ui.wa.paydata.view.WaPaydataQueryDelegator#6c6cee84") != null)
			return (nc.ui.wa.paydata.view.WaPaydataQueryDelegator) context
					.get("nc.ui.wa.paydata.view.WaPaydataQueryDelegator#6c6cee84");
	...
	public nc.ui.wa.paydata.action.SearchAction getSearchAction() {
		if (context.get("SearchAction") != null)
			return (nc.ui.wa.paydata.action.SearchAction) context.get("SearchAction");
		nc.ui.wa.paydata.action.SearchAction bean = new nc.ui.wa.paydata.action.SearchAction();
		context.put("SearchAction", bean);
		bean.setFormEditor(getBillFormEditor());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private java.lang.String getI18nFB_639f53b8() {
		...
		context.put("&nc.ui.uif2.I18nFB#639f53b8", bean);
	...
	private java.lang.String getI18nFB_71318820() {
		...
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#71318820", bean);
		bean.setResDir("xmlcode");
	...
	private java.lang.String getI18nFB_6ae026ee() {
		...
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#6ae026ee", bean);
		bean.setResDir("60130paydata");
	...
	private List getManagedList7() {
		List list = new ArrayList();
		list.add(getHealthCaculateAction());
		list.add(getHealthUnCaculateAction());
		return list;
	}
	...
	private java.lang.String getI18nFB_221c0a13() {
		...
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#221c0a13", bean);
		bean.setResDir("xmlcode");
	...
	private java.lang.String getI18nFB_5ed976e3() {
		...
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#5ed976e3", bean);
		bean.setResDir("xmlcode");
	...
	private nc.ui.hr.append.model.AppendableBillListPanelSetter getAppendableBillListPanelSetter_170c61bb() {
		if (context.get("nc.ui.hr.append.model.AppendableBillListPanelSetter#170c61bb") != null)
			return (nc.ui.hr.append.model.AppendableBillListPanelSetter) context
					.get("nc.ui.hr.append.model.AppendableBillListPanelSetter#170c61bb");
	...
	private List getManagedList12() {
		List list = new ArrayList();
		list.add(getVSNode_693fd7a2());
		list.add(getVSNode_50538972());
		return list;
	}
	...
	public nc.ui.hr.wizard.LayoutPanel getMainListPanel() {
		...
		nc.ui.hr.wizard.LayoutPanel bean = new nc.ui.hr.wizard.LayoutPanel(getBorderLayout_1ba51a27());
	...
	public nc.ui.wa.paydata.view.WaOrgHeadPanelForWa getOrgpanel() {
		if (context.get("orgpanel") != null)
			return (nc.ui.wa.paydata.view.WaOrgHeadPanelForWa) context.get("orgpanel");
		nc.ui.wa.paydata.view.WaOrgHeadPanelForWa bean = new nc.ui.wa.paydata.view.WaOrgHeadPanelForWa(
				getMainListPanel());
