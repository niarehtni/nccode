...
public class payfile extends AbstractJavaBeanDefinition {
	...
	public nc.ui.wa.payfile.model.PayfileModelService getManageModelService() {
		if (context.get("ManageModelService") != null)
			return (nc.ui.wa.payfile.model.PayfileModelService) context.get("ManageModelService");
	...
	public nc.ui.wa.payfile.model.PayfileAppModel getManageAppModel() {
		if (context.get("ManageAppModel") != null)
			return (nc.ui.wa.payfile.model.PayfileAppModel) context.get("ManageAppModel");
	...
	public nc.ui.wa.payfile.model.PayfileModelDataManager getModelDataManager() {
		if (context.get("modelDataManager") != null)
			return (nc.ui.wa.payfile.model.PayfileModelDataManager) context.get("modelDataManager");
	...
	public nc.ui.wa.payfile.view.PayfileListView getListView() {
		if (context.get("listView") != null)
			return (nc.ui.wa.payfile.view.PayfileListView) context.get("listView");
	...
	public nc.ui.wa.payfile.view.PayfileFormEditor getBillFormEditor() {
		if (context.get("billFormEditor") != null)
			return (nc.ui.wa.payfile.view.PayfileFormEditor) context.get("billFormEditor");
	...
	public nc.ui.wa.payfile.action.EditPayfileAction getEditAction() {
		if (context.get("EditAction") != null)
			return (nc.ui.wa.payfile.action.EditPayfileAction) context.get("EditAction");
	...
	public nc.ui.wa.payfile.action.BatchEditPayfileAction getBatchEditAction() {
		if (context.get("BatchEditAction") != null)
			return (nc.ui.wa.payfile.action.BatchEditPayfileAction) context.get("BatchEditAction");
	...
	public nc.ui.wa.payfile.action.FirstLinePayfileAction getFirstLineAction() {
		if (context.get("FirstLineAction") != null)
			return (nc.ui.wa.payfile.action.FirstLinePayfileAction) context.get("FirstLineAction");
	...
	public nc.ui.wa.payfile.action.PreLinePayfileAction getPreLineAction() {
		if (context.get("PreLineAction") != null)
			return (nc.ui.wa.payfile.action.PreLinePayfileAction) context.get("PreLineAction");
	...
	public nc.ui.wa.payfile.action.NextLinePayfileAction getNextLineAction() {
		if (context.get("NextLineAction") != null)
			return (nc.ui.wa.payfile.action.NextLinePayfileAction) context.get("NextLineAction");
	...
	public nc.ui.wa.payfile.action.LastLinePayfileAction getLastLineAction() {
		if (context.get("LastLineAction") != null)
			return (nc.ui.wa.payfile.action.LastLinePayfileAction) context.get("LastLineAction");
	...
	public nc.ui.wa.payfile.action.AddPayfileAction getAddAction() {
		if (context.get("AddAction") != null)
			return (nc.ui.wa.payfile.action.AddPayfileAction) context.get("AddAction");
	...
	public nc.ui.wa.payfile.action.AddPayfilePartAction getAddPartAction() {
		if (context.get("AddPartAction") != null)
			return (nc.ui.wa.payfile.action.AddPayfilePartAction) context.get("AddPartAction");
	...
	public nc.ui.wa.payfile.action.AddPayfileAlterAction getAddAlterAction() {
		if (context.get("AddAlterAction") != null)
			return (nc.ui.wa.payfile.action.AddPayfileAlterAction) context.get("AddAlterAction");
	...
	public nc.ui.wa.payfile.action.AddPayfilePoiAction getAddPoiAction() {
		if (context.get("AddPoiAction") != null)
			return (nc.ui.wa.payfile.action.AddPayfilePoiAction) context.get("AddPoiAction");
	...
	public nc.ui.wa.payfile.action.BatchAddPayfileAction getBatchAddAction() {
		if (context.get("BatchAddAction") != null)
			return (nc.ui.wa.payfile.action.BatchAddPayfileAction) context.get("BatchAddAction");
	...
	public nc.funcnode.ui.action.GroupAction getDeleteActionGroup() {
		if (context.get("deleteActionGroup") != null)
			return (nc.funcnode.ui.action.GroupAction) context.get("deleteActionGroup");
		nc.funcnode.ui.action.GroupAction bean = new nc.funcnode.ui.action.GroupAction();
	...
	public nc.ui.wa.payfile.action.DeletePayfileAction getDeleteAction() {
		if (context.get("DeleteAction") != null)
			return (nc.ui.wa.payfile.action.DeletePayfileAction) context.get("DeleteAction");
	...
	public nc.ui.wa.payfile.action.BatchDeletePayfileAction getBatchDeleteAction() {
		if (context.get("BatchDeleteAction") != null)
			return (nc.ui.wa.payfile.action.BatchDeletePayfileAction) context.get("BatchDeleteAction");
	...
	public nc.ui.wa.payfile.action.CopyPayfileAction getCopyAction() {
		if (context.get("CopyAction") != null)
			return (nc.ui.wa.payfile.action.CopyPayfileAction) context.get("CopyAction");
	...
	public nc.ui.wa.payfile.action.SortPayfileAction getSortAction() {
		if (context.get("SortAction") != null)
			return (nc.ui.wa.payfile.action.SortPayfileAction) context.get("SortAction");
	...
	public nc.ui.wa.payfile.action.AlterPayfileAction getAlterAction() {
		if (context.get("AlterAction") != null)
			return (nc.ui.wa.payfile.action.AlterPayfileAction) context.get("AlterAction");
	...
	public nc.ui.wa.payfile.action.TransferPayfileAction getTransferAction() {
		if (context.get("TransferAction") != null)
			return (nc.ui.wa.payfile.action.TransferPayfileAction) context.get("TransferAction");
	...
	public nc.ui.wa.payfile.action.QueryPayfileAction getQueryAction() {
		if (context.get("QueryAction") != null)
			return (nc.ui.wa.payfile.action.QueryPayfileAction) context.get("QueryAction");
		...
		bean.setDataManager(getModelDataManager());
		bean.setQueryDelegator(getWaPayfileQueryDelegator_77f112());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}

	private nc.ui.wa.payfile.view.WaPayfileQueryDelegator getWaPayfileQueryDelegator_77f112() {
		if (context.get("nc.ui.wa.payfile.view.WaPayfileQueryDelegator#77f112") != null)
			return (nc.ui.wa.payfile.view.WaPayfileQueryDelegator) context
					.get("nc.ui.wa.payfile.view.WaPayfileQueryDelegator#77f112");
		nc.ui.wa.payfile.view.WaPayfileQueryDelegator bean = new nc.ui.wa.payfile.view.WaPayfileQueryDelegator();
		context.put("nc.ui.wa.payfile.view.WaPayfileQueryDelegator#77f112", bean);
		bean.setNodeKey("payfile");
		bean.setContext(getContext());
		bean.setModel(getManageAppModel());
		setBeanFacotryIfBeanFacatoryAware(bean);
	...
	public nc.ui.wa.payfile.action.RefreshPayfileAction getRefreshAction() {
		if (context.get("RefreshAction") != null)
			return (nc.ui.wa.payfile.action.RefreshPayfileAction) context.get("RefreshAction");
	...
	public nc.ui.wa.payfile.action.SavePayfileAction getSaveAction() {
		if (context.get("SaveAction") != null)
			return (nc.ui.wa.payfile.action.SavePayfileAction) context.get("SaveAction");
	...
	public nc.ui.wa.payfile.action.SaveAddPayfileAction getSaveAddAction() {
		if (context.get("SaveAddAction") != null)
			return (nc.ui.wa.payfile.action.SaveAddPayfileAction) context.get("SaveAddAction");
	...
	public nc.ui.wa.payfile.action.CancelPayfileAction getCancelAction() {
		if (context.get("CancelAction") != null)
			return (nc.ui.wa.payfile.action.CancelPayfileAction) context.get("CancelAction");
	...
	public nc.ui.wa.payfile.action.AccountManageAction getAccountManageAction() {
		if (context.get("accountManageAction") != null)
			return (nc.ui.wa.payfile.action.AccountManageAction) context.get("accountManageAction");
	...
	public nc.ui.wa.payfile.action.DisplayAction getDisplayAction() {
		if (context.get("displayAction") != null)
			return (nc.ui.wa.payfile.action.DisplayAction) context.get("displayAction");
	...
	private java.lang.String getI18nFB_73e565() {
		if (context.get("nc.ui.uif2.I18nFB#73e565") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#73e565");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#73e565", bean);
		...
		try {
			...
			context.put("nc.ui.uif2.I18nFB#73e565", product);
	...
	public nc.funcnode.ui.action.GroupAction getCardPrintGroupAction() {
		if (context.get("CardPrintGroupAction") != null)
			return (nc.funcnode.ui.action.GroupAction) context.get("CardPrintGroupAction");
		nc.funcnode.ui.action.GroupAction bean = new nc.funcnode.ui.action.GroupAction();
		context.put("CardPrintGroupAction", bean);
		bean.setCode("print");
		bean.setName(getI18nFB_d95b8e());
	...
	private java.lang.String getI18nFB_d95b8e() {
		if (context.get("nc.ui.uif2.I18nFB#d95b8e") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#d95b8e");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#d95b8e", bean);
		bean.setResDir("xmlcode");
		bean.setDefaultValue("¥´¦L");
		bean.setResId("X60130002");
		setBeanFacotryIfBeanFacatoryAware(bean);
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#d95b8e", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	public nc.ui.hr.uif2.model.HRMetaDataDataSource getCarddatasource() {
		if (context.get("carddatasource") != null)
			return (nc.ui.hr.uif2.model.HRMetaDataDataSource) context.get("carddatasource");
	...
	public nc.ui.hr.uif2.action.print.TemplatePrintAction getCardTemplatePrintAction() {
		if (context.get("CardTemplatePrintAction") != null)
			return (nc.ui.hr.uif2.action.print.TemplatePrintAction) context.get("CardTemplatePrintAction");
	...
	public nc.ui.hr.uif2.action.print.TemplatePreviewAction getCardTemplatePreviewAction() {
		if (context.get("CardTemplatePreviewAction") != null)
			return (nc.ui.hr.uif2.action.print.TemplatePreviewAction) context.get("CardTemplatePreviewAction");
	...
	public nc.ui.hr.uif2.action.print.ExportCardAction getCardTemplateExportAction() {
		if (context.get("CardTemplateExportAction") != null)
			return (nc.ui.hr.uif2.action.print.ExportCardAction) context.get("CardTemplateExportAction");
	...
	public nc.ui.uif2.TangramContainer getContainer() {
		...
		bean.setTangramLayoutRoot(getTBNode_caab5e());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_caab5e() {
		if (context.get("nc.ui.uif2.tangramlayout.node.TBNode#caab5e") != null)
			return (nc.ui.uif2.tangramlayout.node.TBNode) context.get("nc.ui.uif2.tangramlayout.node.TBNode#caab5e");
		nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
		context.put("nc.ui.uif2.tangramlayout.node.TBNode#caab5e", bean);
	...
	private List getManagedList11() {
		List list = new ArrayList();
		list.add(getVSNode_1fa9dac());
		list.add(getVSNode_19f80f2());
		return list;
	}

	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1fa9dac() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#1fa9dac") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context.get("nc.ui.uif2.tangramlayout.node.VSNode#1fa9dac");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#1fa9dac", bean);
		bean.setShowMode("NoDivider");
		bean.setUp(getCNode_9fc62());
		bean.setDown(getCNode_198aae1());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_9fc62() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#9fc62") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#9fc62");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#9fc62", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_198aae1() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#198aae1") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#198aae1");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#198aae1", bean);
	...
	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_19f80f2() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#19f80f2") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context.get("nc.ui.uif2.tangramlayout.node.VSNode#19f80f2");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#19f80f2", bean);
		bean.setShowMode("NoDivider");
		bean.setUp(getCNode_85a3ea());
		bean.setDown(getCNode_1cc6b68());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_85a3ea() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#85a3ea") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#85a3ea");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#85a3ea", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_1cc6b68() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1cc6b68") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#1cc6b68");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#1cc6b68", bean);
	...
	public nc.ui.wa.payfile.view.PayfileOrgHeadPanel getOrgpanel() {
		if (context.get("orgpanel") != null)
			return (nc.ui.wa.payfile.view.PayfileOrgHeadPanel) context.get("orgpanel");
