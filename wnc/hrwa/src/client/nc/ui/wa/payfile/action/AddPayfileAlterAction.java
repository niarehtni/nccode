...
public class AddPayfileAlterAction extends AddPayfileAction {
	...
	public AddPayfileAlterAction() {
		super();
		setBtnName(ResHelper.getString("60130payfile","060130payfile0236")/*@res "新增变动人员"*/);
		...
		putValue(Action.SHORT_DESCRIPTION, ResHelper.getString("60130payfile","060130payfile0237")/*@res "新增变动人员(Ctrl+Shif+A)"*/);
	}
