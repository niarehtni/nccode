...
public class WaFunctionFactory implements IFunctionFactory {
	...
	public List<FormulaItem> getAllFunctions() {
		...
		// mod by Connie.ZH
		// 2019-05-29 started
		fvo = WaFormulaXmlHelper.getFunctionVO(FunctionKey.Cal_Accumulate_Paid);
		HRFormulaItem CalAccumulatePaid = new HRFormulaItem(fvo.getDisplayName(), fvo.getDefaultName(),
				fvo.getInputSig(), fvo.getHintMsg(), fvo.getReturntype());
		items.add(CalAccumulatePaid);
		fvo = WaFormulaXmlHelper.getFunctionVO(FunctionKey.Cal_Paid_Welfare);
		HRFormulaItem CalPaidWelfare = new HRFormulaItem(fvo.getDisplayName(), fvo.getDefaultName(), fvo.getInputSig(),
				fvo.getHintMsg(), fvo.getReturntype());
		items.add(CalPaidWelfare);
		// 2019-05-29 ended
		...
		try {
			...
			taxableOvertimePays.setEditor(editor);
			...
			HRFormulaItem yearlyresthours = new HRFormulaItem(fvo.getDisplayName(), fvo.getDefaultName(),
					fvo.getInputSig(), fvo.getHintMsg(), fvo.getReturntype());
			items.add(yearlyresthours);

			fvo = WaFormulaXmlHelper.getFunctionVO(FunctionKey.LEAVEYEARLYRESTHOURS);
			HRFormulaItem leaveYearlyresthours = new HRFormulaItem(fvo.getDisplayName(), fvo.getDefaultName(),
					fvo.getInputSig(), fvo.getHintMsg(), fvo.getReturntype());
			items.add(leaveYearlyresthours);
			// end
			// }
		...
		// MOD 按日合计离职加班费 LEAVEOVERTIMEFEE
		...
		leaveOverTimeFeeItem.setEditor(editor);
		items.add(leaveOverTimeFeeItem);
		// end MOD

		// 按日合计离职考勤扣款项 LEAVEFEE yejk 18-09-11
		...
		leaveLeaveFeeItem.setEditor(editor);
