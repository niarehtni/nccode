...
public class BonusBaseFunctionEditor extends WaAbstractFunctionEditor {
	private UILabel ivjUILabel = null;
	private UIRefPane refWaItem = null;

	public BonusBaseFunctionEditor() {
		super();
		initialize();
	}

	public String getFuncName() {
		return "@" + ResHelper.getString("6013commonbasic", "06013commonbasic0280") + "@";
	}
	...
	private UIRefPane getRefWaItem() {
		if (this.refWaItem == null) {
			try {
				...
				this.refWaItem.setWhereString(WaItemVO.IITEMTYPE + "=2");
