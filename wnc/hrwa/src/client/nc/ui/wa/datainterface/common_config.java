...
public class common_config extends AbstractJavaBeanDefinition {
	...
	public nc.ui.uif2.TangramContainer getMainPanel() {
		...
		bean.setTangramLayoutRoot(getVSNode_17714a6());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_17714a6() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#17714a6") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context.get("nc.ui.uif2.tangramlayout.node.VSNode#17714a6");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#17714a6", bean);
		bean.setUp(getCNode_8d1cfa());
		bean.setDown(getCNode_6974db());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_8d1cfa() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#8d1cfa") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#8d1cfa");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#8d1cfa", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_6974db() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#6974db") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#6974db");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#6974db", bean);
	...
	public nc.ui.uif2.TangramContainer getIoPanel() {
		...
		bean.setTangramLayoutRoot(getVSNode_1c35da2());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1c35da2() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#1c35da2") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context.get("nc.ui.uif2.tangramlayout.node.VSNode#1c35da2");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#1c35da2", bean);
		bean.setUp(getCNode_ecaf74());
		bean.setDown(getCNode_f2f15a());
		bean.setDividerLocation(30f);
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_ecaf74() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#ecaf74") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#ecaf74");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#ecaf74", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_f2f15a() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#f2f15a") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#f2f15a");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#f2f15a", bean);
	...
	public nc.ui.uif2.TangramContainer getBankPanel() {
		...
		bean.setTangramLayoutRoot(getVSNode_1d554fc());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1d554fc() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#1d554fc") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context.get("nc.ui.uif2.tangramlayout.node.VSNode#1d554fc");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#1d554fc", bean);
		bean.setUp(getCNode_1387628());
		bean.setDown(getCNode_1d568d4());
		bean.setDividerLocation(30f);
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_1387628() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1387628") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#1387628");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#1387628", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_1d568d4() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1d568d4") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#1d568d4");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#1d568d4", bean);
	...
	private java.lang.String getI18nFB_be8907() {
		if (context.get("nc.ui.uif2.I18nFB#be8907") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#be8907");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#be8907", bean);
		...
		try {
			...
			context.put("nc.ui.uif2.I18nFB#be8907", product);
