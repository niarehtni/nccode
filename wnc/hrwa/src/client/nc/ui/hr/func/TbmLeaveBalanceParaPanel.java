...
public class TbmLeaveBalanceParaPanel extends UIPanel implements IParaPanel, IRefPanel {
	...
	public TbmLeaveBalanceParaPanel() {
		initialize();
	}

	public TbmLeaveBalanceParaPanel(LayoutManager p0) {
		super(p0);
	}

	public TbmLeaveBalanceParaPanel(LayoutManager p0, boolean p1) {
		super(p0, p1);
	}

	public TbmLeaveBalanceParaPanel(boolean p0) {
		super(p0);
	}
	...
	private UIComboBox getcmbFunc() {
		if (ivjcmbFunc == null) {
			try {
				...
				String[] ml = new String[] { "上期結餘", "享有", "當前享有", "已休", "結餘", "凍結", "可用" };
