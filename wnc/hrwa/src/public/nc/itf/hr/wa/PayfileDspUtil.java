...
public class PayfileDspUtil {
	...
	private final static String[] defaultShowColKey = new String[] { "pk_psndoc"/* 人员编码 */, "pk_psnjob"/* 员工号 */,
			"pk_psnjob.pk_psndoc.name"/* 姓名 */, "pk_psnjob.pk_psncl"/* 人员类别 */, "workorgvid"/* 任职组织 */,
			"workdeptvid"/* 部门 */, "pk_psnjob.pk_post"/* 岗位 */, "fiporgvid",/* 财务组织 */
			"fipdeptvid",/* 财务部门 */
	...
	private static Map<String, String> initShowNameMap() {
		...
		nameMap.put("pk_banktype3", ResHelper.getString("60130payfile", "160130payfile0010")/*
																							 ...
																							 * "副卡2银行名称"
																							 */);
		nameMap.put("exnhitype", "補充保費計算方式");
		return nameMap;
	}
