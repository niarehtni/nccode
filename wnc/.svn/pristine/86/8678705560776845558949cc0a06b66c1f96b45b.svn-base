...
public class overtime_register_config extends AbstractJavaBeanDefinition {
	...
	public nc.ui.uif2.TangramContainer getContainer() {
		...
		bean.setTangramLayoutRoot(getTBNode_18a70ec());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_18a70ec() {
		if (context.get("nc.ui.uif2.tangramlayout.node.TBNode#18a70ec") != null)
			return (nc.ui.uif2.tangramlayout.node.TBNode) context.get("nc.ui.uif2.tangramlayout.node.TBNode#18a70ec");
		nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
		context.put("nc.ui.uif2.tangramlayout.node.TBNode#18a70ec", bean);
	...
	private List getManagedList3() {
		List list = new ArrayList();
		list.add(getVSNode_c10832());
		list.add(getVSNode_a633ac());
		return list;
	}

	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_c10832() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#c10832") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context.get("nc.ui.uif2.tangramlayout.node.VSNode#c10832");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#c10832", bean);
		bean.setShowMode("NoDivider");
		bean.setUp(getCNode_9a97c6());
		bean.setDown(getHSNode_24eee9());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_9a97c6() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#9a97c6") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#9a97c6");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#9a97c6", bean);
	...
	private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_24eee9() {
		if (context.get("nc.ui.uif2.tangramlayout.node.HSNode#24eee9") != null)
			return (nc.ui.uif2.tangramlayout.node.HSNode) context.get("nc.ui.uif2.tangramlayout.node.HSNode#24eee9");
		nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
		context.put("nc.ui.uif2.tangramlayout.node.HSNode#24eee9", bean);
		bean.setLeft(getCNode_16254c8());
		bean.setRight(getCNode_ac3e28());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_16254c8() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#16254c8") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#16254c8");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#16254c8", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_ac3e28() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#ac3e28") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#ac3e28");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#ac3e28", bean);
	...
	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_a633ac() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#a633ac") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context.get("nc.ui.uif2.tangramlayout.node.VSNode#a633ac");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#a633ac", bean);
		bean.setShowMode("NoDivider");
		bean.setUp(getCNode_1014ba1());
		bean.setDown(getCNode_c5130());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_1014ba1() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1014ba1") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#1014ba1");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#1014ba1", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_c5130() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#c5130") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context.get("nc.ui.uif2.tangramlayout.node.CNode#c5130");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#c5130", bean);
	...
	public nc.ui.uif2.actions.QueryAreaShell getQueryAreaShell() {
		...
		bean.setQueryArea(getQueryAction_created_1fbaf5c());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.queryarea.QueryArea getQueryAction_created_1fbaf5c() {
		if (context.get("QueryAction.created#1fbaf5c") != null)
			return (nc.ui.queryarea.QueryArea) context.get("QueryAction.created#1fbaf5c");
		nc.ui.queryarea.QueryArea bean = getQueryAction().createQueryArea();
		context.put("QueryAction.created#1fbaf5c", bean);
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}
	...
	private java.lang.String getI18nFB_b5fe8e() {
		if (context.get("nc.ui.uif2.I18nFB#b5fe8e") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#b5fe8e");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#b5fe8e", bean);
		...
		try {
			...
			context.put("nc.ui.uif2.I18nFB#b5fe8e", product);
	...
	private java.lang.String getI18nFB_5b3390() {
		if (context.get("nc.ui.uif2.I18nFB#5b3390") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#5b3390");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#5b3390", bean);
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#5b3390", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	public nc.funcnode.ui.action.GroupAction getRestgroup() {
		...
		bean.setCode("rest");
		bean.setName(getI18nFB_196645c());
	...
	private java.lang.String getI18nFB_196645c() {
		if (context.get("nc.ui.uif2.I18nFB#196645c") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#196645c");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#196645c", bean);
		bean.setResDir("6017basedoc");
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#196645c", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	private java.lang.String getI18nFB_96d5db() {
		if (context.get("nc.ui.uif2.I18nFB#96d5db") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#96d5db");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#96d5db", bean);
		bean.setResDir("common");
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#96d5db", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	private java.lang.String getI18nFB_b2203e() {
		if (context.get("nc.ui.uif2.I18nFB#b2203e") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#b2203e");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#b2203e", bean);
		bean.setResDir("common");
		bean.setDefaultValue("打印");
		bean.setResId("UC001-0000007");
		setBeanFacotryIfBeanFacatoryAware(bean);
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#b2203e", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
