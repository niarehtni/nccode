...
public class PsnCalendarValidateImpl implements IPsnCalendarManageValidate	 {
	...
	public List<List<String>> validate(String pk_org, String[] pk_psndocs, UFLiteralDate beginDate,
		...
		Map<Map<Map<String, String>, String>,String> maps = validates.getweekform(pk_org, pk_psndocs, beginDate.toString(), endDate.toString(), psnCalendarVOList);
	...
	//员工工作日历批改（交换）日历天校验
	@Override
	public List<List<String>> updateValidate(String pk_org, String[] pk_psndocs,
		...
		Map<Map<Map<String, String>, String>,String> maps = validates.getweekformdate(pk_org, pk_psndocs, firstDate.toString(), sencodeDate.toString(), infomaps);
	 ...
	 */
	@Override
	public List<List<String>> teamvalidate(String pk_org, String[] pk_teams,
			UFLiteralDate beginDate, UFLiteralDate endDate,String[] pk_shifts)
			throws BusinessException {
		//校验天数的
		Map<String, String> daymap = new HashMap<String,String>();
		//校验小时数的
		...
		Map<Map<Map<String, String>, String>,String>  maps = validates.getweekform(pk_org, pk_psndocs.toArray(new String[pk_psndocs.size()]), beginDate.toString(), endDate.toString(), psnCalendarVOList);
		for(Map<Map<String, String>, String> maplist : maps.keySet()){
			if(maplist.size() > 0){
				for(Map<String, String> mapstr : maplist.keySet()){
					if(maplist.get(mapstr).equals("holidaymessage")){
	 ...
	 */
	@Override
	public List<List<String>> updateteamValidate(String pk_org, String[] pk_teams,
			UFLiteralDate firstDate, UFLiteralDate sencodeDate)
			throws BusinessException {
			//校验天数的
			Map<String, String> daymap = new HashMap<String,String>();
			...
			Map<Map<Map<String, String>, String>,String> maps = validates.getweekformdate(pk_org, pk_psndocs.toArray(new String[pk_psndocs.size()]), firstDate.toString(), sencodeDate.toString(), psnCalendarVOList);
	...
	@Override
	public List<List<String>> updateteamValidate(String pk_org, String[] pk_teams,
			UFLiteralDate changeDate, Integer date_daytype) throws BusinessException {
		//校验天数的
		Map<String, String> daymap = new HashMap<String,String>();
		//校验小时数的
		Map<String, String> hoursmap = new HashMap<String,String>();
		...
		Map<Map<Map<String, String>, String>,String> maps = validates.getweekform(pk_org, psndocslist.toArray(new String[psndocslist.size()]), changeDate.toString(), changeDate.toString(), psnCalendarVOList);
	 ...
	 */
	@Override
	public List<List<String>> updatedayValidate(String pk_org,
			String[] pk_psndocs, UFLiteralDate changeDate, Integer date_daytype)
			throws BusinessException {
		...
		//校验天数的
			...
			Map<Map<Map<String, String>, String>,String> maps = validates.getweekformdate(pk_org, pk_psndocs, changeDate.toString(), changeDate.toString(), psnCalendarVOList);
