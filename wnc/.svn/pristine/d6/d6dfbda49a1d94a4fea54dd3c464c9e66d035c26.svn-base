...
public class poi_config extends AbstractJavaBeanDefinition {
	...
	private List getManagedList1() {
		...
		list.add(getSaveAddPsndocAction());
		list.add(getSeparatorAction());
	...
	public nc.ui.hi.poi.action.AddPoiPsndocAction getAddPsndocAction() {
		if (context.get("addPsndocAction") != null)
			return (nc.ui.hi.poi.action.AddPoiPsndocAction) context
					.get("addPsndocAction");
		nc.ui.hi.poi.action.AddPoiPsndocAction bean = new nc.ui.hi.poi.action.AddPoiPsndocAction();
	...
	public nc.ui.hi.psndoc.action.EditPsndocAction getEditPsndocAction() {
		if (context.get("editPsndocAction") != null)
			return (nc.ui.hi.psndoc.action.EditPsndocAction) context
	...
	public nc.ui.hi.psndoc.action.DeletePsndocAction getDeletePsndocAction() {
		if (context.get("deletePsndocAction") != null)
			return (nc.ui.hi.psndoc.action.DeletePsndocAction) context
	...
	public nc.ui.hi.psndoc.action.QueryPsndocAction getQueryPsndocAction() {
		...
		bean.setModel(getManageAppModel());
		bean.setDataManager(getPsndocDataManager());
		bean.setQueryDelegator(getQueryPsndocDelegator_feffc0());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}

	private nc.ui.hi.psndoc.action.QueryPsndocDelegator getQueryPsndocDelegator_feffc0() {
		if (context.get("nc.ui.hi.psndoc.action.QueryPsndocDelegator#feffc0") != null)
			return (nc.ui.hi.psndoc.action.QueryPsndocDelegator) context
					.get("nc.ui.hi.psndoc.action.QueryPsndocDelegator#feffc0");
		nc.ui.hi.psndoc.action.QueryPsndocDelegator bean = new nc.ui.hi.psndoc.action.QueryPsndocDelegator();
		context.put("nc.ui.hi.psndoc.action.QueryPsndocDelegator#feffc0", bean);
	...
	public nc.ui.hi.poi.action.SavePoiPsndocAction getSavePsndocAction() {
		if (context.get("savePsndocAction") != null)
			return (nc.ui.hi.poi.action.SavePoiPsndocAction) context
					.get("savePsndocAction");
		nc.ui.hi.poi.action.SavePoiPsndocAction bean = new nc.ui.hi.poi.action.SavePoiPsndocAction();
	...
	public nc.ui.hr.uif2.action.SaveAddAction getSaveAddPsndocAction() {
		if (context.get("saveAddPsndocAction") != null)
			return (nc.ui.hr.uif2.action.SaveAddAction) context
					.get("saveAddPsndocAction");
	...
	public nc.ui.hi.psndoc.action.BatchEditPsndocAction getBatchEditAction() {
		if (context.get("batchEditAction") != null)
			return (nc.ui.hi.psndoc.action.BatchEditPsndocAction) context
					.get("batchEditAction");
	...
	public nc.ui.hi.psndoc.action.BatchAddSubSetAction getBatchAddSubSetAction() {
		if (context.get("batchAddSubSetAction") != null)
			return (nc.ui.hi.psndoc.action.BatchAddSubSetAction) context
	...
	public nc.ui.hi.poi.action.StopPoiRelationAction getStopPoiRelationAction() {
		if (context.get("stopPoiRelationAction") != null)
			return (nc.ui.hi.poi.action.StopPoiRelationAction) context
					.get("stopPoiRelationAction");
		nc.ui.hi.poi.action.StopPoiRelationAction bean = new nc.ui.hi.poi.action.StopPoiRelationAction();
		context.put("stopPoiRelationAction", bean);
		bean.setModel(getManageAppModel());
		bean.setFormeditor(getPsndocFormEditor());
		bean.setResourceCode(getResourceCode());
		setBeanFacotryIfBeanFacatoryAware(bean);
	...
	public nc.ui.hi.passaway.PassawayAction getPassawayAction() {
		if (context.get("passawayAction") != null)
			return (nc.ui.hi.passaway.PassawayAction) context
					.get("passawayAction");
		nc.ui.hi.passaway.PassawayAction bean = new nc.ui.hi.passaway.PassawayAction();
		context.put("passawayAction", bean);
		bean.setModel(getManageAppModel());
		bean.setJobstat("Y");
		bean.setResourceID("600723");
		bean.setFormeditor(getPsndocFormEditor());
		bean.setResourceCode(getResourceCode());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
	...
	public nc.funcnode.ui.action.MenuAction getAssistGroup() {
		...
		bean.setCode("assist");
		bean.setName(getI18nFB_148a51f());
	...
	private java.lang.String getI18nFB_148a51f() {
		if (context.get("nc.ui.uif2.I18nFB#148a51f") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#148a51f");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#148a51f", bean);
		...
		try {
			...
			context.put("nc.ui.uif2.I18nFB#148a51f", product);
	...
	private java.lang.String getI18nFB_50ab65() {
		if (context.get("nc.ui.uif2.I18nFB#50ab65") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#50ab65");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#50ab65", bean);
		bean.setResDir("6001uif2");
		bean.setResId("x6001uif20001");
		bean.setDefaultValue("辅助功能");
		setBeanFacotryIfBeanFacatoryAware(bean);
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#50ab65", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	private Map getManagedMap0() {
		...
		map.put("3", "nc.vo.hr.validator.HKIDCardValidator");
		return map;
	}
	...
	public nc.ui.hr.tools.uilogic.SuperLogicProcessor getAdditionalValidationOfSave() {
		...
		bean.setMethods(getManagedList9());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}
	...
	public nc.ui.om.psnnavi.model.NaviTreeAppModelDataManager getLeftModelDataManager() {
		if (context.get("leftModelDataManager") != null)
			return (nc.ui.om.psnnavi.model.NaviTreeAppModelDataManager) context
					.get("leftModelDataManager");
	...
	public nc.ui.om.psnnavi.model.NaviLeftAppModel getLeftSuperModel() {
		if (context.get("leftSuperModel") != null)
			return (nc.ui.om.psnnavi.model.NaviLeftAppModel) context
					.get("leftSuperModel");
	...
	public nc.vo.om.psnnavi.NaviPropertyVO getNaviProperty() {
		if (context.get("naviProperty") != null)
			return (nc.vo.om.psnnavi.NaviPropertyVO) context
					.get("naviProperty");
		...
		bean.setNaviItems(getManagedList10());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}
	...
	public nc.ui.hr.uif2.model.HrDefaultAppModelService getTreeModelServicePostSeries() {
		if (context.get("treeModelServicePostSeries") != null)
			return (nc.ui.hr.uif2.model.HrDefaultAppModelService) context
					.get("treeModelServicePostSeries");
		nc.ui.hr.uif2.model.HrDefaultAppModelService bean = new nc.ui.hr.uif2.model.HrDefaultAppModelService();
	...
	public nc.ui.om.psnnavi.view.AOSNaviTreeCreateStrategy getTreeCreateStrategyOrg() {
		if (context.get("treeCreateStrategyOrg") != null)
			return (nc.ui.om.psnnavi.view.AOSNaviTreeCreateStrategy) context
					.get("treeCreateStrategyOrg");
		...
		bean.setRootName(getI18nFB_109d67c());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}

	private java.lang.String getI18nFB_109d67c() {
		if (context.get("nc.ui.uif2.I18nFB#109d67c") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#109d67c");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#109d67c", bean);
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#109d67c", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	public nc.ui.om.psnnavi.model.AOSNaviAppModel getTreeAppModelOrg() {
		if (context.get("treeAppModelOrg") != null)
			return (nc.ui.om.psnnavi.model.AOSNaviAppModel) context
					.get("treeAppModelOrg");
	...
	public nc.ui.om.psnnavi.view.MsAOSNaviTreeCreateStrategy getTreeCreateStrategyMsAOS() {
		if (context.get("treeCreateStrategyMsAOS") != null)
			return (nc.ui.om.psnnavi.view.MsAOSNaviTreeCreateStrategy) context
					.get("treeCreateStrategyMsAOS");
		...
		bean.setFactory(getBoadatorfactory());
		bean.setRootName(getI18nFB_e073bb());
	...
	private java.lang.String getI18nFB_e073bb() {
		if (context.get("nc.ui.uif2.I18nFB#e073bb") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#e073bb");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#e073bb", bean);
		bean.setResDir("menucode");
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#e073bb", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	public nc.vo.bd.meta.BDObjectTreeCreateStrategy getTreeCreateStrategyPsnType() {
		...
		bean.setFactory(getBoadatorfactory());
		bean.setRootName(getI18nFB_1ce2585());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}

	private java.lang.String getI18nFB_1ce2585() {
		if (context.get("nc.ui.uif2.I18nFB#1ce2585") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#1ce2585");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#1ce2585", bean);
		bean.setResDir("menucode");
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#1ce2585", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	public nc.ui.uif2.model.HierachicalDataAppModel getTreeAppModelPsnType() {
		if (context.get("treeAppModelPsnType") != null)
			return (nc.ui.uif2.model.HierachicalDataAppModel) context
					.get("treeAppModelPsnType");
	...
	public nc.vo.bd.meta.BDObjectTreeCreateStrategy getTreeCreateStrategyPostSeries() {
		if (context.get("treeCreateStrategyPostSeries") != null)
			return (nc.vo.bd.meta.BDObjectTreeCreateStrategy) context
					.get("treeCreateStrategyPostSeries");
		nc.vo.bd.meta.BDObjectTreeCreateStrategy bean = new nc.vo.bd.meta.BDObjectTreeCreateStrategy();
		context.put("treeCreateStrategyPostSeries", bean);
		bean.setFactory(getBoadatorfactory());
		bean.setRootName(getI18nFB_1016dd9());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}

	private java.lang.String getI18nFB_1016dd9() {
		if (context.get("nc.ui.uif2.I18nFB#1016dd9") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#1016dd9");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#1016dd9", bean);
		bean.setResDir("menucode");
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#1016dd9", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	public nc.ui.om.psnnavi.view.TreePanel_Org getTreePanelOrg() {
		if (context.get("treePanelOrg") != null)
			return (nc.ui.om.psnnavi.view.TreePanel_Org) context
					.get("treePanelOrg");
	...
	public nc.ui.om.psnnavi.view.TreePanelOfMsAOS getTreePanelMsAOS() {
		if (context.get("treePanelMsAOS") != null)
			return (nc.ui.om.psnnavi.view.TreePanelOfMsAOS) context
					.get("treePanelMsAOS");
	...
	public nc.ui.om.psnnavi.view.TreePanel_PsnType getTreePanelPsnType() {
		if (context.get("treePanelPsnType") != null)
			return (nc.ui.om.psnnavi.view.TreePanel_PsnType) context
					.get("treePanelPsnType");
	...
	public nc.ui.om.psnnavi.view.TreePanel_PostSeries getTreePanelPostSeries() {
		if (context.get("treePanelPostSeries") != null)
			return (nc.ui.om.psnnavi.view.TreePanel_PostSeries) context
					.get("treePanelPostSeries");
	...
	public nc.ui.om.psnnavi.view.NaviStylePanel getNaviStylePanel() {
		if (context.get("naviStylePanel") != null)
			return (nc.ui.om.psnnavi.view.NaviStylePanel) context
					.get("naviStylePanel");
	...
	public nc.ui.uif2.tangramlayout.node.VSNode getNaviNode() {
		...
		bean.setUp(getCNode_d2dfd2());
		bean.setDown(getCNode_648293());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_d2dfd2() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#d2dfd2") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#d2dfd2");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#d2dfd2", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_648293() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#648293") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#648293");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#648293", bean);
	...
	public nc.ui.om.psnnavi.view.TreePanelContainer getTreeContainer() {
		if (context.get("treeContainer") != null)
			return (nc.ui.om.psnnavi.view.TreePanelContainer) context
					.get("treeContainer");
	...
	public nc.ui.hi.psndoc.model.PsndocModelService getPsndocModelService() {
		if (context.get("psndocModelService") != null)
			return (nc.ui.hi.psndoc.model.PsndocModelService) context
	...
	public java.util.HashSet getBusinessInfoSet() {
		...
		java.util.HashSet bean = new java.util.HashSet(getManagedList11());
	...
	public java.util.HashSet getDisableTabSet() {
		...
		java.util.HashSet bean = new java.util.HashSet(getManagedList12());
	...
	public nc.ui.hi.psndoc.model.PsndocInitDataListener getInitDataListener() {
		if (context.get("InitDataListener") != null)
			return (nc.ui.hi.psndoc.model.PsndocInitDataListener) context
	...
	public nc.ui.hi.poi.model.PoiPsndocModel getManageAppModel() {
		if (context.get("manageAppModel") != null)
			return (nc.ui.hi.poi.model.PoiPsndocModel) context
					.get("manageAppModel");
		nc.ui.hi.poi.model.PoiPsndocModel bean = new nc.ui.hi.poi.model.PoiPsndocModel();
	...
	public nc.ui.hi.psndoc.view.PsndocFormEditor getPsndocFormEditor() {
		...
		bean.setNodekey("bd_psndoc");
		bean.setTabActions(getManagedList14());
	...
	public nc.ui.hr.uif2.view.HrPsnclTemplateContainer getTemplateContainer() {
		...
		bean.setContext(getContext());
		bean.setNodeKeies(getManagedList16());
		bean.load();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	public nc.ui.uif2.TangramContainer getContainer() {
		...
		bean.setTangramLayoutRoot(getTBNode_fa56e3());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_fa56e3() {
		if (context.get("nc.ui.uif2.tangramlayout.node.TBNode#fa56e3") != null)
			return (nc.ui.uif2.tangramlayout.node.TBNode) context
					.get("nc.ui.uif2.tangramlayout.node.TBNode#fa56e3");
		nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
		context.put("nc.ui.uif2.tangramlayout.node.TBNode#fa56e3", bean);
	...
	private List getManagedList17() {
		List list = new ArrayList();
		list.add(getVSNode_1732945());
		list.add(getVSNode_59077b());
		return list;
	}

	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1732945() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#1732945") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context
					.get("nc.ui.uif2.tangramlayout.node.VSNode#1732945");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#1732945", bean);
		bean.setShowMode("NoDivider");
		bean.setUp(getCNode_df4d01());
		bean.setDown(getHSNode_26ae25());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_df4d01() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#df4d01") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#df4d01");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#df4d01", bean);
	...
	private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_26ae25() {
		if (context.get("nc.ui.uif2.tangramlayout.node.HSNode#26ae25") != null)
			return (nc.ui.uif2.tangramlayout.node.HSNode) context
					.get("nc.ui.uif2.tangramlayout.node.HSNode#26ae25");
		nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
		context.put("nc.ui.uif2.tangramlayout.node.HSNode#26ae25", bean);
		bean.setLeft(getCNode_3894b1());
		bean.setRight(getCNode_aa147b());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_3894b1() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#3894b1") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#3894b1");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#3894b1", bean);
		bean.setComponent(getTreeContainer());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_aa147b() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#aa147b") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#aa147b");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#aa147b", bean);
	...
	private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_59077b() {
		if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#59077b") != null)
			return (nc.ui.uif2.tangramlayout.node.VSNode) context
					.get("nc.ui.uif2.tangramlayout.node.VSNode#59077b");
		nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
		context.put("nc.ui.uif2.tangramlayout.node.VSNode#59077b", bean);
		bean.setShowMode("NoDivider");
		bean.setUp(getCNode_19aa719());
		bean.setDown(getCNode_505e35());
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_19aa719() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#19aa719") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#19aa719");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#19aa719", bean);
	...
	private nc.ui.uif2.tangramlayout.node.CNode getCNode_505e35() {
		if (context.get("nc.ui.uif2.tangramlayout.node.CNode#505e35") != null)
			return (nc.ui.uif2.tangramlayout.node.CNode) context
					.get("nc.ui.uif2.tangramlayout.node.CNode#505e35");
		nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
		context.put("nc.ui.uif2.tangramlayout.node.CNode#505e35", bean);
