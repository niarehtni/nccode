...
public class SelPsnPanelForOutJoin extends UIPanel implements ICompWithValidateFunc,AppEventListener, ValueChangedListener {
	...
	public void init(){
		...
		add(getSelPsnPanelForOutJoin(), BorderLayout.CENTER);
	}
...
//	}
	...
	protected ConditionSelPsnPanel getSelPsnPanelForOutJoin(){
		if(selPanel == null){
