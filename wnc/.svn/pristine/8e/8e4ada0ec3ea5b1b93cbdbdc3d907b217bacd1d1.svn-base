...
public class workcalendar_globe extends AbstractJavaBeanDefinition {
  ...
  public nc.vo.bd.meta.BDObjectTreeCreateStrategy getTreestrategy() {
    ...
    bean.setRootName(getI18nFB_f110b9());
    setBeanFacotryIfBeanFacatoryAware(bean);
    invokeInitializingBean(bean);
    return bean;
  }

  private java.lang.String getI18nFB_f110b9() {
    if (context.get("nc.ui.uif2.I18nFB#f110b9") != null)
      return (java.lang.String) context.get("nc.ui.uif2.I18nFB#f110b9");
    nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#f110b9", bean);
    ...
    try {
      ...
      context.put("nc.ui.uif2.I18nFB#f110b9", product);
  ...
  public nc.ui.uif2.components.TreePanel getTreePanel() {
    ...
    bean.setModel(getAppmodel());
    bean.setTreeCellRenderer(getBDTreeCellRenderer_811888());
    bean.initUI();
    setBeanFacotryIfBeanFacatoryAware(bean);
    invokeInitializingBean(bean);
    return bean;
  ...
  private nc.ui.bd.pub.BDTreeCellRenderer getBDTreeCellRenderer_811888() {
    if (context.get("nc.ui.bd.pub.BDTreeCellRenderer#811888") != null)
      return (nc.ui.bd.pub.BDTreeCellRenderer) context
          .get("nc.ui.bd.pub.BDTreeCellRenderer#811888");
    nc.ui.bd.pub.BDTreeCellRenderer bean = new nc.ui.bd.pub.BDTreeCellRenderer();
    context.put("nc.ui.bd.pub.BDTreeCellRenderer#811888", bean);
    bean.setContext(getContext());
    setBeanFacotryIfBeanFacatoryAware(bean);
    invokeInitializingBean(bean);
    return bean;
  ...
  public nc.ui.bd.workcalendar.view.WorkCalendarAddDeailDlgMediator getDetailAddMediator() {
    ...
    bean.setName(getI18nFB_171c686());
  ...
  private java.lang.String getI18nFB_171c686() {
    if (context.get("nc.ui.uif2.I18nFB#171c686") != null)
      return (java.lang.String) context.get("nc.ui.uif2.I18nFB#171c686");
    nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#171c686", bean);
    bean.setResDir("10140wcb");
    ...
    try {
      Object product = bean.getObject();
      context.put("nc.ui.uif2.I18nFB#171c686", product);
      return (java.lang.String) product;
    }
    catch (Exception e) {
      throw new RuntimeException(e);
...
*/
  ...
  private List getManagedList1() {
    List list = new ArrayList();
    list.add(getWorkCalendarNullValidator_531047());
    list.add(getWorkCalendarDateValidator_151aba3());
    return list;
  }

  private nc.bs.bd.workcalendar.validator.WorkCalendarNullValidator getWorkCalendarNullValidator_531047() {
    if (context.get("nc.bs.bd.workcalendar.validator.WorkCalendarNullValidator#531047") != null)
      return (nc.bs.bd.workcalendar.validator.WorkCalendarNullValidator) context
          .get("nc.bs.bd.workcalendar.validator.WorkCalendarNullValidator#531047");
    ...
    context.put("nc.bs.bd.workcalendar.validator.WorkCalendarNullValidator#531047", bean);
    setBeanFacotryIfBeanFacatoryAware(bean);
    invokeInitializingBean(bean);
    return bean;
  }

  private nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator getWorkCalendarDateValidator_151aba3() {
    if (context.get("nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator#151aba3") != null)
      return (nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator) context
          .get("nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator#151aba3");
    ...
    context.put("nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator#151aba3", bean);
    setBeanFacotryIfBeanFacatoryAware(bean);
    invokeInitializingBean(bean);
    return bean;
  }
  ...
  private List getManagedList2() {
    List list = new ArrayList();
    list.add(getWorkCalendarAddDetailNullValidator_db6b6b());
    list.add(getWorkCalendarDateValidator_1697bca());
    return list;
  }

  private nc.bs.bd.workcalendar.validator.WorkCalendarAddDetailNullValidator getWorkCalendarAddDetailNullValidator_db6b6b() {
    if (context.get("nc.bs.bd.workcalendar.validator.WorkCalendarAddDetailNullValidator#db6b6b") != null)
      return (nc.bs.bd.workcalendar.validator.WorkCalendarAddDetailNullValidator) context
          .get("nc.bs.bd.workcalendar.validator.WorkCalendarAddDetailNullValidator#db6b6b");
    ...
    context.put("nc.bs.bd.workcalendar.validator.WorkCalendarAddDetailNullValidator#db6b6b", bean);
    setBeanFacotryIfBeanFacatoryAware(bean);
    invokeInitializingBean(bean);
    return bean;
  }

  private nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator getWorkCalendarDateValidator_1697bca() {
    if (context.get("nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator#1697bca") != null)
      return (nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator) context
          .get("nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator#1697bca");
    nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator bean =
        new nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator();
    context.put("nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator#1697bca", bean);
    setBeanFacotryIfBeanFacatoryAware(bean);
    invokeInitializingBean(bean);
    return bean;
  }
  ...
  private List getManagedList3() {
    List list = new ArrayList();
    list.add(getWorkCalendarDateValidator_3e11a7());
    return list;
  }

  private nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator getWorkCalendarDateValidator_3e11a7() {
    if (context.get("nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator#3e11a7") != null)
      return (nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator) context
          .get("nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator#3e11a7");
    nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator bean =
        new nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator();
    context.put("nc.bs.bd.workcalendar.validator.WorkCalendarDateValidator#3e11a7", bean);
    setBeanFacotryIfBeanFacatoryAware(bean);
    invokeInitializingBean(bean);
    return bean;
  }
  ...
  private java.lang.String getI18nFB_f8ef2b() {
    if (context.get("nc.ui.uif2.I18nFB#f8ef2b") != null)
      return (java.lang.String) context.get("nc.ui.uif2.I18nFB#f8ef2b");
    nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#f8ef2b", bean);
    ...
    try {
      Object product = bean.getObject();
      context.put("nc.ui.uif2.I18nFB#f8ef2b", product);
      return (java.lang.String) product;
    }
    catch (Exception e) {
      throw new RuntimeException(e);
  ...
  public nc.ui.uif2.TangramContainer getContainer() {
    ...
    bean.setTangramLayoutRoot(getHSNode_2fd63e());
  ...
  private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_2fd63e() {
    if (context.get("nc.ui.uif2.tangramlayout.node.HSNode#2fd63e") != null)
      return (nc.ui.uif2.tangramlayout.node.HSNode) context
          .get("nc.ui.uif2.tangramlayout.node.HSNode#2fd63e");
    nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
    context.put("nc.ui.uif2.tangramlayout.node.HSNode#2fd63e", bean);
    bean.setLeft(getCNode_1dd81f3());
    bean.setRight(getVSNode_cfcb5b());
  ...
  private nc.ui.uif2.tangramlayout.node.CNode getCNode_1dd81f3() {
    if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1dd81f3") != null)
      return (nc.ui.uif2.tangramlayout.node.CNode) context
          .get("nc.ui.uif2.tangramlayout.node.CNode#1dd81f3");
    nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
    context.put("nc.ui.uif2.tangramlayout.node.CNode#1dd81f3", bean);
  ...
  private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_cfcb5b() {
    if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#cfcb5b") != null)
      return (nc.ui.uif2.tangramlayout.node.VSNode) context
          .get("nc.ui.uif2.tangramlayout.node.VSNode#cfcb5b");
    nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
    context.put("nc.ui.uif2.tangramlayout.node.VSNode#cfcb5b", bean);
    bean.setUp(getCNode_17e84c2());
    bean.setDown(getCNode_13e0553());
  ...
  private nc.ui.uif2.tangramlayout.node.CNode getCNode_17e84c2() {
    if (context.get("nc.ui.uif2.tangramlayout.node.CNode#17e84c2") != null)
      return (nc.ui.uif2.tangramlayout.node.CNode) context
          .get("nc.ui.uif2.tangramlayout.node.CNode#17e84c2");
    nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
    context.put("nc.ui.uif2.tangramlayout.node.CNode#17e84c2", bean);
  ...
  private nc.ui.uif2.tangramlayout.node.CNode getCNode_13e0553() {
    if (context.get("nc.ui.uif2.tangramlayout.node.CNode#13e0553") != null)
      return (nc.ui.uif2.tangramlayout.node.CNode) context
          .get("nc.ui.uif2.tangramlayout.node.CNode#13e0553");
    nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
    context.put("nc.ui.uif2.tangramlayout.node.CNode#13e0553", bean);
  ...
  private List getManagedList6() {
    ...
    list.add(getSeparatorAction());
    list.add(getDefaultCalendarAction());
    return list;
  }
