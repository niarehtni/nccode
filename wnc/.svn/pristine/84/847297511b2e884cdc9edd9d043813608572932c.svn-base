...
public class PsnLaborDataVO extends SuperVO {
    ...
    private String pk_nhicalc;// 计算行PK
    ...
    private UFDouble commonHeaRate = UFDouble.ZERO_DBL;// 普通健保费率
    private UFDouble commonHeaRate_Psn = UFDouble.ZERO_DBL;// 普通健保費承擔比例(個人)
    private UFDouble commonHeaRate_Org = UFDouble.ZERO_DBL;// 普通健保費承擔比例(僱主)
    private UFDouble aveNum = UFDouble.ZERO_DBL;// 平均眷口數
    ...
    public UFDouble getCommonHeaRate() {
	if (commonHeaRate == null) {
	    commonHeaRate = UFDouble.ZERO_DBL;
	}
	return commonHeaRate;
    }

    public void setCommonHeaRate(UFDouble commonHeaRate) {
	this.commonHeaRate = commonHeaRate;
    }
    ...
    public UFDouble getAveNum() {
	if (aveNum == null) {
	    aveNum = UFDouble.ZERO_DBL;
	}
	return aveNum;
    }

    public void setAveNum(UFDouble aveNum) {
	this.aveNum = aveNum;
    }
    ...
    public UFDouble getCommonHeaRate_Psn() {
	return commonHeaRate_Psn;
    }

    public void setCommonHeaRate_Psn(UFDouble commonHeaRate_Psn) {
	this.commonHeaRate_Psn = commonHeaRate_Psn;
    }

    public UFDouble getCommonHeaRate_Org() {
	return commonHeaRate_Org;
    }

    public void setCommonHeaRate_Org(UFDouble commonHeaRate_Org) {
	this.commonHeaRate_Org = commonHeaRate_Org;
    }
