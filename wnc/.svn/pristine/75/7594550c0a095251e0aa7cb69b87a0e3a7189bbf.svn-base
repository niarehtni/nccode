 ...
 * @修改日期:
 */
public class PsnWadocSubPane extends HrBillFormEditor implements
		BillEditListener, BillEditListener2, AppEventListener,
	...
	static {
		// 谈判工资 增加
		NEGOTIATION_WAGEADD_STATE.put(PsndocWadocVO.PK_WA_ITEM_SHOWNAME,
				new Boolean(true));
		NEGOTIATION_WAGEADD_STATE.put(PsndocWadocVO.PK_WA_GRD_SHOWNAME,
				new Boolean(true));
		NEGOTIATION_WAGEADD_STATE.put(PsndocWadocVO.BEGINDATE,
				new Boolean(true));
		NEGOTIATION_WAGEADD_STATE.put(PsndocWadocVO.ENDDATE, new Boolean(true));
		NEGOTIATION_WAGEADD_STATE.put(PsndocWadocVO.CHANGEDATE, new Boolean(
				true));
		NEGOTIATION_WAGEADD_STATE.put(PsndocWadocVO.NEGOTIATION_WAGE,
				new Boolean(true));
		NEGOTIATION_WAGEADD_STATE.put(PsndocWadocVO.PK_WA_CRT_SHOWNAME,
				new Boolean(false));
		NEGOTIATION_WAGEADD_STATE.put(PsndocWadocVO.CRITERIONVALUE,
				new Boolean(false));
		...
		NEGOTIATION_WAGEADD_STATE.put(PsndocWadocVO.LASTFLAG,
				new Boolean(false));
		NEGOTIATION_WAGEADD_STATE.put(PsndocWadocVO.DOCNAME, new Boolean(true));
		NEGOTIATION_WAGEADD_STATE.put(PsndocWadocVO.PK_CHANGECAUSE,
				new Boolean(true));
		NEGOTIATION_WAGEADD_STATE.put(PsndocWadocVO.VBASEFILE,
				new Boolean(true));
		// 谈判工资 插入
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.PK_WA_ITEM_SHOWNAME,
				new Boolean(false));
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.PK_WA_GRD_SHOWNAME,
				new Boolean(true));
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.BEGINDATE, new Boolean(
				true));
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.ENDDATE, new Boolean(
				true));
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.CHANGEDATE, new Boolean(
				true));
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.NEGOTIATION_WAGE,
				new Boolean(true));
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.PK_WA_CRT_SHOWNAME,
				new Boolean(false));
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.CRITERIONVALUE,
				new Boolean(false));
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.NMONEY,
				new Boolean(true));
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.WAFLAG,
				new Boolean(true));
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.LASTFLAG, new Boolean(
				false));
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.DOCNAME, new Boolean(
				true));
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.PK_CHANGECAUSE,
				new Boolean(true));
		NEGOTIATION_WAGEINSERT_STATE.put(PsndocWadocVO.VBASEFILE, new Boolean(
				true));
		// 谈判工资 修改
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.PK_WA_ITEM_SHOWNAME,
				new Boolean(false));
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.PK_WA_GRD_SHOWNAME,
				new Boolean(true));
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.BEGINDATE, new Boolean(
				true));
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.ENDDATE, new Boolean(
				true));
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.CHANGEDATE, new Boolean(
				true));
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.NEGOTIATION_WAGE,
				new Boolean(true));
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.PK_WA_CRT_SHOWNAME,
				new Boolean(false));
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.CRITERIONVALUE,
				new Boolean(false));
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.NMONEY,
				new Boolean(true));
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.WAFLAG,
				new Boolean(true));
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.LASTFLAG, new Boolean(
				false));
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.DOCNAME, new Boolean(
				true));
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.PK_CHANGECAUSE,
				new Boolean(true));
		NEGOTIATION_WAGEMODIFY_STATE.put(PsndocWadocVO.VBASEFILE, new Boolean(
				true));
		// 非谈判工资 新增
		...
		// 非谈判工资 插入
		WAGEINSERT_STATE.put(PsndocWadocVO.PK_WA_ITEM_SHOWNAME, new Boolean(
				false));
		WAGEINSERT_STATE.put(PsndocWadocVO.PK_WA_GRD_SHOWNAME,
				new Boolean(true));
		...
		WAGEINSERT_STATE.put(PsndocWadocVO.PK_WA_CRT_SHOWNAME,
				new Boolean(true));
		...
		// 非谈判工资 修改
		WAGEMODIFY_STATE.put(PsndocWadocVO.PK_WA_ITEM_SHOWNAME, new Boolean(
				false));
		WAGEMODIFY_STATE.put(PsndocWadocVO.PK_WA_GRD_SHOWNAME,
				new Boolean(true));
		...
		WAGEMODIFY_STATE.put(PsndocWadocVO.PK_WA_CRT_SHOWNAME,
				new Boolean(true));
	...
	public void initUI() {
		...
		UIRefPane grdRefpane = (UIRefPane) this.getBillCardPanel()
				.getBodyItem(PsndocWadocVO.PK_WA_GRD_SHOWNAME).getComponent();
		...
		getBillCardPanel().getBodyPanel()
				.getShowCol(PsndocWadocVO.PK_WA_GRD_SHOWNAME)
				.setCellRenderer(cellRenderer);

		UIRefPane itemRefpane = (UIRefPane) this.getBillCardPanel()
				.getBodyItem(PsndocWadocVO.PK_WA_ITEM_SHOWNAME).getComponent();
		itemRefpane.addValueChangedListener(this);
		itemRefpane.setButtonFireEvent(true);

		UIRefPane applyRefpane = (UIRefPane) this.getBillCardPanel()
				.getBodyItem(PsndocWadocVO.PK_WA_CRT_SHOWNAME).getComponent();
		applyRefpane.addValueChangedListener(this);
		applyRefpane.setButtonFireEvent(true);

		UIRefPane docRefpane = (UIRefPane) this.getBillCardPanel()
				.getBodyItem(PsndocWadocVO.DOCNAME).getComponent();
		docRefpane.addValueChangedListener(this);
		docRefpane.setButtonFireEvent(true);

		getBillCardPanel().setBillTableEnterKeyControler("PsndocWadocVO",
	...
	private void addDecimalListener() {
		String[] billitems = new String[] { PsndocWadocVO.CRITERIONVALUE,
				PsndocWadocVO.NMONEY };
		IBillModelDecimalListener2 bmd = new WaItemDecimalAdapter(
				WaItemVO.PK_WA_ITEM, billitems,
	...
	public void setSubVOs(PsndocWadocMainVO vo) {
		mainVO = vo;
		try {
			PsndocWadocVO[] subvos = WASalaryadjmgtDelegator
					.getPsndocWadocQueryService().queryAllVOsByPsnPKForHI(
	...
	private boolean isEditable(boolean blnIsEditable, int row, String keyName) {
		...
		Boolean workflowFlag = (Boolean) getBodyCellValue(row,
				PsndocWadocVO.WORKFLOWFLAG);
		if (row == last_select_row_number) {
			if (PsndocwadocCommonDef.MODIFY_STATE.equals(getModelState())
					&& workflowFlag) {
				// 只能修改最新记录的发放标志
				int index = billModel.getBodyColByKey(PsndocWadocVO.WAFLAG);
				int index2 = billModel.getBodyColByKey(PsndocWadocVO.ENDDATE);
				int index3 = billModel
						.getBodyColByKey(PsndocWadocVO.CHANGEDATE);
				if (col == index || col == index2 || col == index3) {
					isEditable = true;
				}
			} else if (!PsndocwadocCommonDef.UNKNOWN_STATE
					.equals(getModelState())) {
				Boolean boolean1 = getStateHash(getModelState(),
						negotiation_wage).get(keyName);
	...
	public void onAdd() {
		...
		refreshItemRef();
		// 发放记录， 最新标志全部选择
		setBodyCellValue(UFBoolean.valueOf(true), last_select_row_number,
				PsndocWadocVO.WAFLAG);
		setBodyCellValue(UFBoolean.valueOf(true), last_select_row_number,
				PsndocWadocVO.LASTFLAG);
		...
		setBodyCellValue(mainVO.getPartflag(), last_select_row_number,
				PsndocWadocVO.PARTFLAG);
		setBodyCellValue(mainVO.getAssgid(), last_select_row_number,
				PsndocWadocVO.ASSGID);
	...
	private void onInsert() throws BusinessException {
		...
		if (selectRow == -1) {
			...
			throw new BusinessException(ResHelper.getString("60130adjmtc",
					"060130adjmtc0217")/* @res "请选择插入的位置！" */);
		}
		String name = getBodyCellValue(selectRow,
				PsndocWadocVO.PK_WA_ITEM_SHOWNAME).toString();
		String pk_wa_item = getBodyCellValue(selectRow,
				PsndocWadocVO.PK_WA_ITEM).toString();
		String recordnum = getBodyCellValue(selectRow, PsndocWadocVO.RECORDNUM)
				.toString();
		...
		setBodyCellValue(UFBoolean.valueOf(true), selectRow,
				PsndocWadocVO.WAFLAG);
		setBodyCellValue(0, selectRow, PsndocWadocVO.WORKFLOWFLAG);
		setBodyCellValue(UFBoolean.valueOf(false), selectRow,
				PsndocWadocVO.LASTFLAG);
		setBodyCellValue(mainVO.getPartflag(), selectRow,
				PsndocWadocVO.PARTFLAG);
		...
		// 初始化薪资标准参照
		refreshGradeRef(PsndocWadocVO.PK_WA_GRD_SHOWNAME, new WaGradeRefModel(
				pk_wa_item, this.getModel().getContext().getPk_org()));
	 ...
	 * @return
	 */
	public PsndocWadocVO getSelectVO(Integer selectrow)
			throws BusinessException {
		PsndocWadocVO selectVO = new PsndocWadocVO();
		getBillCardPanel().stopEditing();
		int selectRow = selectrow == null ? last_select_row_number : selectrow;
		selectVO = (PsndocWadocVO) billModel.getBodyValueRowVO(selectRow,
	...
	public void setWadocData(PsndocWadocVO[] subVOs) {
		...
		if (subVOs != null) {
			for (PsndocWadocVO vo : subVOs) {
				vo.setCriterionvalue(new UFDouble(SalaryDecryptUtil.decrypt((vo
						.getCriterionvalue() == null ? new UFDouble(0) : vo
						.getCriterionvalue()).toDouble())));
				vo.setNmoney(new UFDouble(
						SalaryDecryptUtil.decrypt((vo.getNmoney() == null ? new UFDouble(
								0) : vo.getNmoney()).toDouble())));
			}
		}
		// end
		this.subVOs = subVOs;
	...
	public void afterEdit(BillEditEvent e) {
		...
		// 薪资标准发生变化
			...
			refpane = (UIRefPane) ((BillCellEditor) e.getSource())
					.getComponent();
	...
	private void changeWaItem(int rowIndex) {
		// 清空薪资标准等
		String[] clearRow = new String[] { PsndocWadocVO.PK_WA_GRD_SHOWNAME,
				PsndocWadocVO.PK_WA_GRD, PsndocWadocVO.NEGOTIATION_WAGE,
				PsndocWadocVO.PK_WA_CRT_SHOWNAME, PsndocWadocVO.NMONEY,
				PsndocWadocVO.CRITERIONVALUE,

				PsndocWadocVO.ISRANGE, PsndocWadocVO.CRT_MIN_VALUE,
				PsndocWadocVO.CRT_MAX_VALUE, };
		for (String strKey : clearRow) {
			setBodyCellValue(null, rowIndex, strKey);
		}
		// 记住薪资项目主键
		pkWaItem = ((UIRefPane) billModel.getBodyItems()[PK_WA_ITEM_INDEX]
				.getComponent()).getRefPK();

		// 初始化薪资标准参照
		refreshGradeRef(PsndocWadocVO.PK_WA_GRD_SHOWNAME, new WaGradeRefModel(
				pkWaItem, this.getModel().getContext().getPk_org()));
	...
	public PsndocWadocVO[] getUIData() {
		return (PsndocWadocVO[]) getBillCardPanel().getBillModel()
				.getBodyValueVOs(PsndocWadocVO.class.getName());
	}
	...
	private void changeWaGrd(int rowIndex) {
		// 清空薪资标准等
		String[] clearRow = new String[] { PsndocWadocVO.NEGOTIATION_WAGE,
				PsndocWadocVO.PK_WA_CRT_SHOWNAME, PsndocWadocVO.NMONEY,
				PsndocWadocVO.CRITERIONVALUE,/* PsndocWadocVO.PK_WA_CRT, */
		...
		// 记住薪资项目主键
		Object StrGrdPK = ((UIRefPane) billModel.getBodyItems()[PK_WA_GRD_INDEX]
				.getComponent()).getRefPK();
		...
		if (strPkWaItem != null && mainVO.getPk_psndoc() != null
			...
			try {
				...
				psnappaproveBVO.setWa_apply_money(new UFDouble(
						SalaryDecryptUtil.decrypt((psnappaproveBVO
								.getWa_apply_money() == null ? new UFDouble(0)
								: psnappaproveBVO.getWa_apply_money())
								.toDouble())));
				// end
				setBodyCellValue(
						psnappaproveBVO
								.getAttributeValue(PsnappaproveBVO.NEGOTIATION),
						rowIndex, PsndocWadocVO.NEGOTIATION_WAGE);
				setBodyCellValue(
						psnappaproveBVO
								.getAttributeValue(PsnappaproveBVO.PK_WA_CRT_APPLY_SHOWNAME),
						rowIndex, PsndocWadocVO.PK_WA_CRT_SHOWNAME);
				setBodyCellValue(
						psnappaproveBVO
								.getAttributeValue(PsnappaproveBVO.WA_CRT_APPLY_MONEY),
						rowIndex, PsndocWadocVO.NMONEY);
				setBodyCellValue(
						psnappaproveBVO
								.getAttributeValue(PsnappaproveBVO.WA_APPLY_MONEY),
						rowIndex, PsndocWadocVO.CRITERIONVALUE);
				setBodyCellValue(
						psnappaproveBVO
								.getAttributeValue(PsnappaproveBVO.PK_WA_CRT),
						rowIndex, PsndocWadocVO.PK_WA_CRT);
				setBodyCellValue(
						psnappaproveBVO
								.getAttributeValue(PsnappaproveBVO.PK_WA_PRMLV_APPLY),
						rowIndex, PsndocWadocVO.PK_WA_PRMLV);
				setBodyCellValue(
						psnappaproveBVO
								.getAttributeValue(PsnappaproveBVO.PK_WA_SECLV_APPLY),
						rowIndex, PsndocWadocVO.PK_WA_SECLV);
				// 更改表体的参照
				refreshCriterion(StrGrdPK.toString(), rowIndex);
			} catch (BusinessException e) {
				Logger.error(e.getMessage(), e);
				MessageDialog.showErrorDlg(getModel().getContext()
						.getEntranceUI(), null, e.getMessage());
				return;
			}
		}
	}
	...
	private void changeWaCrt4Dia(int rowIndex, WaCriterionVO crtVO) {
		...
		String[] clearRow = new String[] {
				// 申请薪资
				PsndocWadocVO.CRITERIONVALUE, PsndocWadocVO.NMONEY,
				PsndocWadocVO.PK_WA_SECLV, PsndocWadocVO.PK_WA_PRMLV,
				PsndocWadocVO.PK_WA_CRT_SHOWNAME, PsndocWadocVO.CRT_MIN_VALUE,
				PsndocWadocVO.CRT_MAX_VALUE, PsndocWadocVO.PK_WA_CRT };
		for (String strKey : clearRow) {
			setBodyCellValue(null, rowIndex, strKey);
		}
	...
	private void changeNegotiationWage(int rowIndex) {
		String[] neededClearKeys = {
				...
				// 申请薪资
				PsndocWadocVO.PK_WA_PRMLV, PsndocWadocVO.PK_WA_SECLV,
				PsndocWadocVO.CRITERIONVALUE, PsndocWadocVO.PK_WA_CRT_SHOWNAME };
		for (String strKey : neededClearKeys) {
			setBodyCellValue(null, rowIndex, strKey);
		}

		Object object = getBodyCellValue(rowIndex,
				PsndocWadocVO.NEGOTIATION_WAGE);
		if (object != null) {
	...
	public void bodyRowChange(BillEditEvent e) {
		...
		if (row > -1) {
			...
			if (pk_wa_grd != null) {
				refreshGradeRef(PsndocWadocVO.PK_WA_GRD_SHOWNAME,
						new WaGradeRefModel(pkWaItem, this.getModel()
	...
	private void refreshGradeRef(String strColKey, AbstractRefModel refModel) {
		...
		UIRefPane refPane = (UIRefPane) billModel.getBodyItems()[intColKeyIndex]
				.getComponent();
	...
	private void refreshItemRef() {
		// 根据列的字段找到对应的列的INDEX
		UIRefPane refpane = (UIRefPane) billModel.getBodyItems()[PK_WA_ITEM_INDEX]
				.getComponent();
	 ...
	 * @return
	 */
	private Map<String, Boolean> getStateHash(String state,
	...
	private void setCellEditableController() {
		getBillCardPanel().getBillModel().setCellEditableController(
				new BillModelCellEditableController() {
	...
	public boolean beforeEdit(BillEditEvent e) {
		...
		if (((BillItem) e.getSource()).getKey().equals("docname")) {
			UIRefPane changeCauseRefpane = (UIRefPane) ((BillItem) e
