...
public class LeaveServiceFacade{
	...
	public static LeaveRegVO[] queryByPsnsLeaveTypePeriod(String pk_org,
		...
		return getService().queryByPsnsLeaveTypePeriod(pk_org, pk_psnorgs, typeVO, year, periodBeginDate, periodEndDate,leaveindex);
	}

	public static LeavebVO[] queryBeforePassWithoutNoPassByPsnsLeaveTypePeriod(
			String pk_org, String[] pk_psnorgs, LeaveTypeCopyVO typeVO,
			String year, UFLiteralDate periodBeginDate,
			UFLiteralDate periodEndDate, Integer leaveindex) throws BusinessException {
		return getService().queryBeforePassWithoutNoPassByPsnsLeaveTypePeriod(pk_org, pk_psnorgs, typeVO, year, periodBeginDate, periodEndDate, leaveindex);
	}
}
