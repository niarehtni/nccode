 ...
 * @since: eHR V6.0
 */
public class TaxableOvertimePaysPreExcutor extends AbstractFormulaExecutor {
	...
	public void excute(Object pk_wa_wageform, WaLoginContext context) throws BusinessException {
		...
		//本地化启基适配 Ares.Tank 2018-10-19 16:36:35
/*
		Map<String, UFDouble> calculateTaxFreeAmountByPeriod = NCLocator.getInstance().lookup((ISegDetailService.class)
				.calculateTaxableAmountByPeriod(context.getPk_org(), psndocs, cyear, cperiod);*/
