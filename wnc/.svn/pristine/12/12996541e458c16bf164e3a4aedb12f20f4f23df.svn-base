...
public class OTBalanceDetailVO extends nc.vo.pub.SuperVO {
    ...
    /**
     * 屬性 pk_otleavebalance的Getter方法.屬性名：parentPK 創建日期:2018/10/25
     * 
    ...
    /**
     * 屬性pk_otleavebalance的Setter方法.屬性名：parentPK 創建日期:2018/10/25
     * 
    ...
    /**
     * 屬性 pk_balancedetail的Getter方法.屬性名：子表主鍵 創建日期:2018/10/25
     * 
     * @return java.lang.String
     */
    ...
    /**
     * 屬性pk_balancedetail的Setter方法.屬性名：子表主鍵 創建日期:2018/10/25
     * 
    ...
    /**
     * 屬性 sourcetype的Getter方法.屬性名：源單類型 創建日期:2018/10/25
     * 
    ...
    /**
     * 屬性sourcetype的Setter方法.屬性名：源單類型 創建日期:2018/10/25
     * 
     * @param newSourcetype
     *            java.lang.Integer
     */
    ...
    /**
     * 屬性 pk_sourcebill的Getter方法.屬性名：源單單據PK 創建日期:2018/10/25
     * 
     * @return java.lang.String
     */
    ...
    /**
     * 屬性pk_sourcebill的Setter方法.屬性名：源單單據PK 創建日期:2018/10/25
     * 
    ...
    /**
     * 屬性 calendar的Getter方法.屬性名：源單日期 創建日期:2018/10/25
     * 
    ...
    /**
     * 屬性calendar的Setter方法.屬性名：源單日期 創建日期:2018/10/25
     * 
     * @param newCalendar
    ...
    /**
     * 屬性 billhours的Getter方法.屬性名：源單 創建日期:2018/10/25
     * 
    ...
    /**
     * 屬性billhours的Setter方法.屬性名：源單 創建日期:2018/10/25
     * 
     * @param newBillhours
    ...
    /**
     * 屬性 consumedhours的Getter方法.屬性名：已用 創建日期:2018/10/25
     * 
     * @return nc.vo.pub.lang.UFDouble
     */
    ...
    /**
     * 屬性consumedhours的Setter方法.屬性名：已用 創建日期:2018/10/25
     * 
    ...
    /**
     * 屬性 closeflag的Getter方法.屬性名：是否結束 創建日期:2018/10/25
     * 
    ...
    /**
     * 屬性closeflag的Setter方法.屬性名：是否結束 創建日期:2018/10/25
     * 
     * @param newCloseflag
