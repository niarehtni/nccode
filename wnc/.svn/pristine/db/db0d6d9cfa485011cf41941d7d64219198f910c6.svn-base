...
public class WadaysalaryServiceImpl implements IWadaysalaryService {
	...
	String checkSql = "SELECT DISTINCT\n" + "	tbmpsndoc.pk_org,\n" + "	calendar.calendardate,\n"
		...
		+ ")\n" + "WHERE\n" + "	wadoc.waflag = 'Y'\n and tbmpsndoc.pk_org is not null " 
	...
	@Override
	public Map<String, UFDouble> statisticLeavecharge(String[] pk_psndocs,
		...
		for (int i = 0; i < listMaps.size(); i++) {
			...
			UFDouble totalleavecharge = hashMap.get("totalleavecharge") != null ? new UFDouble(
					hashMap.get("totalleavecharge").toString())
					: UFDouble.ZERO_DBL;
