 ...
 * @since: V63
 */
public class PrePeriodStartDate extends AbstractWAFormulaParse {
	private static final long serialVersionUID = 1406850386974419229L;
	...
	public FunctionReplaceVO getReplaceStr(String formula)
		...
		UFLiteralDate startDay =periodStateVO.getCstartdate();

		fvo.setReplaceStr(" '" + startDay.toStdString() + "' ");
