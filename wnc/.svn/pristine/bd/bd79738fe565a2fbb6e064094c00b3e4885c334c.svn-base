...
public nc.ui.uif2.TangramContainer getMainPanel(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("mainPanel");
  ...
  bean.setTangramLayoutRoot(getVSNode_6a53f9d8());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_6a53f9d8(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#6a53f9d8")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#6a53f9d8");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#6a53f9d8",bean);
  bean.setUp(getCNode_30634e7());
  bean.setDown(getCNode_c7b2b3e());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_30634e7(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#30634e7")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#30634e7");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#30634e7",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_c7b2b3e(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#c7b2b3e")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#c7b2b3e");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#c7b2b3e",bean);
...
public nc.ui.uif2.TangramContainer getIoPanel(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("ioPanel");
  ...
  bean.setTangramLayoutRoot(getVSNode_76cb771e());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_76cb771e(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#76cb771e")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#76cb771e");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#76cb771e",bean);
  bean.setUp(getCNode_2f380a71());
  bean.setDown(getCNode_83598ef());
  bean.setDividerLocation(30f);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_2f380a71(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#2f380a71")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#2f380a71");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#2f380a71",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_83598ef(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#83598ef")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#83598ef");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#83598ef",bean);
...
public nc.ui.uif2.TangramContainer getBankPanel(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("bankPanel");
  ...
  bean.setTangramLayoutRoot(getVSNode_26b53114());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_26b53114(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#26b53114")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#26b53114");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#26b53114",bean);
  bean.setUp(getCNode_27f98f80());
  bean.setDown(getCNode_713c3100());
  bean.setDividerLocation(30f);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_27f98f80(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#27f98f80")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#27f98f80");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#27f98f80",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_713c3100(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#713c3100")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#713c3100");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#713c3100",bean);
...
public nc.ui.wa.datainterface.action.SalaryInsuranceExportAction getSalaryInsuranceExportAction(){
 ...
 return (nc.ui.wa.datainterface.action.SalaryInsuranceExportAction)context.get("salaryInsuranceExportAction");
...
public nc.funcnode.ui.action.GroupAction getPrintActionMenu(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("printActionMenu");
  ...
  bean.setCode("print");
  bean.setName(getI18nFB_41a92be6());
...
private java.lang.String getI18nFB_41a92be6(){
 if(context.get("nc.ui.uif2.I18nFB#41a92be6")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#41a92be6");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#41a92be6",bean);  bean.setResDir("xmlcode");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#41a92be6",product);
