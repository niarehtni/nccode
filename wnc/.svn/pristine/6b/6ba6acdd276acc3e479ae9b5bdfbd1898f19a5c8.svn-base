...
public class PsndocwadocAppModel extends BillManageModel {
	 ...
	 */
	public void saveInsertSelectVO(PsndocWadocVO selectVO)
			throws BusinessException {
		WASalaryadjmgtDelegator.getPsndocwadocManageService()
				.insertPsndocWadocVO(selectVO);
	}
	 ...
	 * @throws BusinessException
	 */
	public void saveModifySelectVO(PsndocWadocVO selectVO)
			throws BusinessException {
		WASalaryadjmgtDelegator.getPsndocwadocManageService()
				.updatePsndocWadoc(selectVO);
	}
	...
	public void insertArray(PsndocWadocVO[] selectVOs) throws BusinessException {
		WASalaryadjmgtDelegator.getPsndocwadocManageService().insertArray(
				selectVOs);
	}
	 ...
	 * @throws BusinessException
	 */
	public PsndocWadocMainVO[] getWadocMain(String partFlag, String querywhere)
			throws BusinessException {
	 ...
	 * @throws BusinessException
	 */
	private PsndocWadocMainVO[] getWadocMain(String partFlag,
			String querywhere, String strItemPK, String strGrdPK)
			throws BusinessException {
		return WASalaryadjmgtDelegator.getPsndocWadocQueryService()
				.queryWadocMainData(this.getContext(), partFlag, querywhere,
						null, strItemPK, strGrdPK);

	}

	public String[][] queryAllItemForWadoc(LoginContext context)
			throws BusinessException {
		return WASalaryadjmgtDelegator.getPsndocWadocQueryService()
				.queryAllItemForWadoc(context);
	}
	...
	public AdjustWadocVO[] onRefresh4BatchAdjust(BatchAdjustVO batchadjustVO)
			throws BusinessException {
		return getWadocMain4BatchAdjust(getContext(), getQuerywhere(),
				batchadjustVO);
	}
	...
	private AdjustWadocVO[] getWadocMain4BatchAdjust(LoginContext loginContext,
		...
		return WASalaryadjmgtDelegator.getPsndocwadocManageService()
				.queryWadocMainData4AdjustInfo(loginContext, strWhere, null,
						batchadjustVO);
	...
	public WaGradeVO queryWagradeVoByGradePk(String strPK)
			throws BusinessException {
		return WASalaryadjmgtDelegator.getAdjustQueryService()
				.queryWagradeVoByGradePk(strPK);
	}
	 ...
	 * @return
	 */
	public PsndocWadocVO[] importData2DB(PsndocWadocVO[] psndocWadocVOs,
		...
		for (PsndocWadocVO vo : psndocWadocVOs) {
			...
			vo.setNmoney(vo.getNmoney() == null ? null : new UFDouble(
					SalaryEncryptionUtil.encryption(vo.getNmoney().toDouble())));
		}
		// end
		return WASalaryadjmgtDelegator.getPsndocwadocManageService()
				.importData2DB(psndocWadocVOs, context);
	}
	...
	public void setAdjustWadocPsnInfoVOs(
			AdjustWadocPsnInfoVO[] adjustWadocPsnInfoVOs) {
	...
	public PsndocWadocVO[] queryPsndocWadocsByPsncode(String[] psncodes)
			throws BusinessException {
		return WASalaryadjmgtDelegator.getPsndocWadocQueryService()
				.queryPsndocWadocsByPsncode(psncodes);
	}

	// 同步人员
	public void psndocWadocSaveToWainfoVO(PsndocWadocVO[] psndocWadocs)
			throws BusinessException {
		WASalaryadjmgtDelegator.getPsndocWadocQueryService()
				.psndocWadocSaveToWainfoVO(psndocWadocs);
	}
