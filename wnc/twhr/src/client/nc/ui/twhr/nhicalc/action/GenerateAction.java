...
public class GenerateAction extends NCAction {
	...
	if (MessageDialog.showYesNoDlg(getModel().getContext().getEntranceUI(),
	    ...
	    genSrv.generateAdjustNHIData(this.getOrgpanel().getRefPane().getRefPK(), this.getOrgpanel()
	    ...
	    ShowStatusBarMsgUtil.showStatusBarMsg("勞健保設定生成成功。", this.getModel().getContext());
	}
    }
